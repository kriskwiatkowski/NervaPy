        ...
        if is_r8(self.operands[0]) and is_imm(self.operands[1]):
            ...
            if is_al(self.operands[0]):
                self.encodings.append(
                    (0x01, lambda op: bytearray([0x04, op[1] & 0xFF]))
                )
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0x80, 0xC0 | op[0].lcode, op[1] & 0xFF]),
                )
            )
            ...
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(
                        op[1].hcode, op[0], rex or is_r8rex(op[0]) or is_r8rex(op[1])
                    )
                    + bytearray([0x00, 0xC0 | op[1].lcode << 3 | op[0].lcode]),
                )
            )
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(
                        op[0].hcode, op[1], rex or is_r8rex(op[0]) or is_r8rex(op[1])
                    )
                    + bytearray([0x02, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False, sib=False, min_disp=0: optional_rex(
                        op[0].hcode, op[1].address, rex or is_r8rex(op[0])
                    )
                    + bytearray([0x02])
            ...
            if is_imm8(self.operands[1], ext_size=2):
                self.encodings.append(
                    (
                        ...
                        + bytearray([0x83, 0xC0 | op[0].lcode, op[1] & 0xFF]),
                    )
                )
            if is_ax(self.operands[0]):
                self.encodings.append(
                    (
                        0x01,
                        lambda op: bytearray(
                            [0x66, 0x05, op[1] & 0xFF, (op[1] >> 8) & 0xFF]
                        ),
                    )
                )
            self.encodings.append(
                (
                    ...
                    + optional_rex(0, op[0], rex)
                    + bytearray(
                        [0x81, 0xC0 | op[0].lcode, op[1] & 0xFF, (op[1] >> 8) & 0xFF]
                    ),
                )
            )
            self.in_regs = (True, False)
            ...
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[1].hcode, op[0], rex)
                    + bytearray([0x01, 0xC0 | op[1].lcode << 3 | op[0].lcode]),
                )
            )
            self.encodings.append(
                (
                    ...
                    + bytearray([0x03, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
            self.in_regs = (True, True)
            self.out_regs = (True, False)
            ...
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(op[1].hcode, op[0], rex)
                    + bytearray([0x01, 0xC0 | op[1].lcode << 3 | op[0].lcode]),
                )
            )
            self.encodings.append(
            ...
            if is_imm8(self.operands[1], ext_size=8):
                self.encodings.append(
                    (
                        0x00,
                        lambda op: bytearray(
                            [0x48 | op[0].hcode, 0x83, 0xC0 | op[0].lcode, op[1] & 0xFF]
                        ),
                    )
                )
            ...
            self.encodings.append(
                (
                    ...
                    lambda op: bytearray(
                        [
                            0x48 | op[1].hcode << 2 | op[0].hcode,
                            0x01,
                            0xC0 | op[1].lcode << 3 | op[0].lcode,
                        ]
                    ),
                )
            )
            ...
            self.encodings.append(
                (
                    0x10,
                    lambda op, sib=False, min_disp=0: rex(1, op[0].hcode, op[1].address)
                    + bytearray([0x03])
                    + modrm_sib_disp(op[0].lcode, op[1].address, sib, min_disp),
                )
            )
            ...
            self.encodings.append(
                (
                    ...
                    + bytearray([0x80])
                    + modrm_sib_disp(0, op[0].address, sib, min_disp)
                    + bytearray([op[1] & 0xFF]),
                )
            )
            self.in_regs = (True, False)
            ...
            self.encodings.append(
                (
                    0x30,
                    lambda op, rex=False, sib=False, min_disp=0: optional_rex(
                        op[1].hcode, op[0].address, rex or is_r8rex(op[1])
                    )
                    + bytearray([0x00])
            ...
            if is_imm8(self.operands[1], ext_size=2):
                self.encodings.append(
                    (
                        0x30,
                        lambda op, rex=False, sib=False, min_disp=0: bytearray([0x66])
                        + optional_rex(0, op[0].address, rex)
                        + bytearray([0x83])
                        + modrm_sib_disp(0, op[0].address, sib, min_disp)
                        + bytearray([op[1] & 0xFF]),
                    )
            ...
            self.encodings.append(
                (
                    ...
                    + bytearray([0x81])
                    + modrm_sib_disp(0, op[0].address, sib, min_disp)
                    + bytearray([op[1] & 0xFF, (op[1] >> 8) & 0xFF]),
                )
            )
            self.in_regs = (True, False)
            self.out_regs = (False, False)
            ...
            self.encodings.append(
                (
                    0x30,
                    lambda op, rex=False, sib=False, min_disp=0: bytearray([0x66])
                    + optional_rex(op[1].hcode, op[0].address, rex)
                    + bytearray([0x01])
                    + modrm_sib_disp(op[1].lcode, op[0].address, sib, min_disp),
                )
            )
            ...
            if is_imm8(self.operands[1], ext_size=8):
                self.encodings.append(
                    (
                        0x10,
                        lambda op, sib=False, min_disp=0: rex(1, 0, op[0].address)
                        + bytearray([0x83])
                        + modrm_sib_disp(0, op[0].address, sib, min_disp)
                        + bytearray([op[1] & 0xFF]),
                    )
            ...
            self.encodings.append(
                (
                    0x10,
                    lambda op, sib=False, min_disp=0: rex(1, op[1].hcode, op[0].address)
                    + bytearray([0x01])
                    + modrm_sib_disp(op[1].lcode, op[0].address, sib, min_disp),
                )
            )
    ...
    def __init__(self, *args, **kwargs):
        ...
        * SUB(r8/m8, r8)
        ...
        if is_r8(self.operands[0]) and is_imm(self.operands[1]):
            ...
            if is_al(self.operands[0]):
                self.encodings.append(
                    (0x01, lambda op: bytearray([0x2C, op[1] & 0xFF]))
                )
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0x80, 0xE8 | op[0].lcode, op[1] & 0xFF]),
                )
            )
            self.in_regs = (True, False)
            self.out_regs = (True, False)
            ...
            self.encodings.append(
                (
                    ...
                    + bytearray([0x28, 0xC0 | op[1].lcode << 3 | op[0].lcode]),
                )
            )
            self.encodings.append(
                (
                    ...
                    + bytearray([0x2A, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
            self.in_regs = (True, True)
            self.out_regs = (True, False)
            ...
            if is_imm8(self.operands[1], ext_size=2):
                self.encodings.append(
                    (
                        ...
                        lambda op, rex=False: bytearray([0x66])
                        + optional_rex(0, op[0], rex)
                        + bytearray([0x83, 0xE8 | op[0].lcode, op[1] & 0xFF]),
                    )
                )
            if is_ax(self.operands[0]):
                self.encodings.append(
                    (
                        0x01,
                        lambda op: bytearray(
                            [0x66, 0x2D, op[1] & 0xFF, (op[1] >> 8) & 0xFF]
                        ),
                    )
                )
            self.encodings.append(
                (
                    ...
                    + optional_rex(0, op[0], rex)
                    + bytearray(
                        [0x81, 0xE8 | op[0].lcode, op[1] & 0xFF, (op[1] >> 8) & 0xFF]
                    ),
                )
            )
            self.in_regs = (True, False)
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[1].hcode, op[0], rex)
                    + bytearray([0x29, 0xC0 | op[1].lcode << 3 | op[0].lcode]),
                )
            )
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[0].hcode, op[1], rex)
                    + bytearray([0x2B, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
            self.in_regs = (True, True)
            self.out_regs = (True, False)
            ...
            if is_imm8(self.operands[1], ext_size=8):
                self.encodings.append(
                    (
                        0x00,
                        lambda op: bytearray(
                            [0x48 | op[0].hcode, 0x83, 0xE8 | op[0].lcode, op[1] & 0xFF]
                        ),
                    )
                )
            if is_rax(self.operands[0]):
            ...
            self.encodings.append(
                (
                    ...
                    + bytearray([0x80])
                    + modrm_sib_disp(5, op[0].address, sib, min_disp)
                    + bytearray([op[1] & 0xFF]),
                )
            )
            self.in_regs = (True, False)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * ADC(r8/m8, r8)
        ...
        if is_r8(self.operands[0]) and is_imm(self.operands[1]):
            ...
            if is_al(self.operands[0]):
                self.encodings.append(
                    (0x01, lambda op: bytearray([0x14, op[1] & 0xFF]))
                )
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0x80, 0xD0 | op[0].lcode, op[1] & 0xFF]),
                )
            )
            self.in_regs = (True, False)
            self.out_regs = (True, False)
            ...
            self.encodings.append(
                (
                    ...
                    + bytearray([0x10, 0xC0 | op[1].lcode << 3 | op[0].lcode]),
                )
            )
            self.encodings.append(
                (
                    ...
                    + bytearray([0x12, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
            self.in_regs = (True, True)
            self.out_regs = (True, False)
            ...
            if is_imm8(self.operands[1], ext_size=2):
                self.encodings.append(
                    (
                        ...
                        lambda op, rex=False: bytearray([0x66])
                        + optional_rex(0, op[0], rex)
                        + bytearray([0x83, 0xD0 | op[0].lcode, op[1] & 0xFF]),
                    )
                )
            if is_ax(self.operands[0]):
                self.encodings.append(
                    (
                        0x01,
                        lambda op: bytearray(
                            [0x66, 0x15, op[1] & 0xFF, (op[1] >> 8) & 0xFF]
                        ),
                    )
                )
            self.encodings.append(
                (
                    ...
                    + optional_rex(0, op[0], rex)
                    + bytearray(
                        [0x81, 0xD0 | op[0].lcode, op[1] & 0xFF, (op[1] >> 8) & 0xFF]
                    ),
                )
            )
            self.in_regs = (True, False)
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[1].hcode, op[0], rex)
                    + bytearray([0x11, 0xC0 | op[1].lcode << 3 | op[0].lcode]),
                )
            )
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[0].hcode, op[1], rex)
                    + bytearray([0x13, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
            self.in_regs = (True, True)
            self.out_regs = (True, False)
            ...
            if is_imm8(self.operands[1], ext_size=8):
                self.encodings.append(
                    (
                        0x00,
                        lambda op: bytearray(
                            [0x48 | op[0].hcode, 0x83, 0xD0 | op[0].lcode, op[1] & 0xFF]
                        ),
                    )
                )
            if is_rax(self.operands[0]):
            ...
            self.encodings.append(
                (
                    ...
                    + bytearray([0x80])
                    + modrm_sib_disp(2, op[0].address, sib, min_disp)
                    + bytearray([op[1] & 0xFF]),
                )
            )
            self.in_regs = (True, False)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * SBB(r8/m8, r8)
        ...
        if is_r8(self.operands[0]) and is_imm(self.operands[1]):
            ...
            if is_al(self.operands[0]):
                self.encodings.append(
                    (0x01, lambda op: bytearray([0x1C, op[1] & 0xFF]))
                )
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0x80, 0xD8 | op[0].lcode, op[1] & 0xFF]),
                )
            )
            self.in_regs = (True, False)
            self.out_regs = (True, False)
            ...
            self.encodings.append(
                (
                    ...
                    + bytearray([0x18, 0xC0 | op[1].lcode << 3 | op[0].lcode]),
                )
            )
            self.encodings.append(
                (
                    ...
                    + bytearray([0x1A, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
            self.in_regs = (True, True)
            self.out_regs = (True, False)
            ...
            if is_imm8(self.operands[1], ext_size=2):
                self.encodings.append(
                    (
                        ...
                        lambda op, rex=False: bytearray([0x66])
                        + optional_rex(0, op[0], rex)
                        + bytearray([0x83, 0xD8 | op[0].lcode, op[1] & 0xFF]),
                    )
                )
            if is_ax(self.operands[0]):
                self.encodings.append(
                    (
                        0x01,
                        lambda op: bytearray(
                            [0x66, 0x1D, op[1] & 0xFF, (op[1] >> 8) & 0xFF]
                        ),
                    )
                )
            self.encodings.append(
                (
                    ...
                    + optional_rex(0, op[0], rex)
                    + bytearray(
                        [0x81, 0xD8 | op[0].lcode, op[1] & 0xFF, (op[1] >> 8) & 0xFF]
                    ),
                )
            )
            self.in_regs = (True, False)
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[1].hcode, op[0], rex)
                    + bytearray([0x19, 0xC0 | op[1].lcode << 3 | op[0].lcode]),
                )
            )
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[0].hcode, op[1], rex)
                    + bytearray([0x1B, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
            self.in_regs = (True, True)
            self.out_regs = (True, False)
            ...
            if is_imm8(self.operands[1], ext_size=8):
                self.encodings.append(
                    (
                        0x00,
                        lambda op: bytearray(
                            [0x48 | op[0].hcode, 0x83, 0xD8 | op[0].lcode, op[1] & 0xFF]
                        ),
                    )
                )
            if is_rax(self.operands[0]):
            ...
            self.encodings.append(
                (
                    ...
                    + bytearray([0x80])
                    + modrm_sib_disp(3, op[0].address, sib, min_disp)
                    + bytearray([op[1] & 0xFF]),
                )
            )
            self.in_regs = (True, False)
...
class ADCX(Instruction):
    ...
    def __init__(self, *args, **kwargs):
        ...
        * ADCX(r64, r64/m64)    [ADX]
        ...
        self.out_regs = (True, False)
        self.out_operands = (True, False)
        self.isa_extensions = frozenset([nervapy.x86_64.isa.adx])
        if is_r32(self.operands[0]) and is_r32(self.operands[1]):
            ...
            self.encodings.append(
                (
                    ...
                    + optional_rex(op[0].hcode, op[1], rex)
                    + bytearray(
                        [0x0F, 0x38, 0xF6, 0xC0 | op[0].lcode << 3 | op[1].lcode]
                    ),
                )
            )
        elif is_r32(self.operands[0]) and is_m32(self.operands[1]):
            ...
            self.encodings.append(
                (
                    0x10,
                    lambda op, sib=False, min_disp=0: bytearray([0x66])
                    + rex(1, op[0].hcode, op[1].address)
                    + bytearray([0x0F, 0x38, 0xF6])
                    + modrm_sib_disp(op[0].lcode, op[1].address, sib, min_disp),
                )
            )
        ...
        * ADOX(r64, r64/m64)    [ADX]
        ...
        if is_r32(self.operands[0]) and is_r32(self.operands[1]):
            ...
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: bytearray([0xF3])
                    + optional_rex(op[0].hcode, op[1], rex)
                    + bytearray(
                        [0x0F, 0x38, 0xF6, 0xC0 | op[0].lcode << 3 | op[1].lcode]
                    ),
            ...
            self.encodings.append(
                (
                    0x30,
                    lambda op, rex=False, sib=False, min_disp=0: bytearray([0xF3])
                    + optional_rex(op[0].hcode, op[1].address, rex)
                    + bytearray([0x0F, 0x38, 0xF6])
                    + modrm_sib_disp(op[0].lcode, op[1].address, sib, min_disp),
                )
            ...
            self.encodings.append(
                (
                    0x10,
                    lambda op, sib=False, min_disp=0: bytearray([0xF3])
                    + rex(1, op[0].hcode, op[1].address)
                    + bytearray([0x0F, 0x38, 0xF6])
                    + modrm_sib_disp(op[0].lcode, op[1].address, sib, min_disp),
                )
    ...
    def __init__(self, *args, **kwargs):
        ...
        * AND(r8/m8, r8)
        ...
        if is_r8(self.operands[0]) and is_imm(self.operands[1]):
            ...
            if is_al(self.operands[0]):
                self.encodings.append(
                    (0x01, lambda op: bytearray([0x24, op[1] & 0xFF]))
                )
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0x80, 0xE0 | op[0].lcode, op[1] & 0xFF]),
                )
            )
            self.in_regs = (True, False)
            self.out_regs = (True, False)
            ...
            self.encodings.append(
                (
                    ...
                    + bytearray([0x20, 0xC0 | op[1].lcode << 3 | op[0].lcode]),
                )
            )
            self.encodings.append(
                (
                    ...
                    + bytearray([0x22, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
            self.in_regs = (True, True)
            self.out_regs = (True, False)
            ...
            if is_imm8(self.operands[1], ext_size=2):
                self.encodings.append(
                    (
                        ...
                        lambda op, rex=False: bytearray([0x66])
                        + optional_rex(0, op[0], rex)
                        + bytearray([0x83, 0xE0 | op[0].lcode, op[1] & 0xFF]),
                    )
                )
            if is_ax(self.operands[0]):
                self.encodings.append(
                    (
                        0x01,
                        lambda op: bytearray(
                            [0x66, 0x25, op[1] & 0xFF, (op[1] >> 8) & 0xFF]
                        ),
                    )
                )
            self.encodings.append(
                (
                    ...
                    + optional_rex(0, op[0], rex)
                    + bytearray(
                        [0x81, 0xE0 | op[0].lcode, op[1] & 0xFF, (op[1] >> 8) & 0xFF]
                    ),
                )
            )
            self.in_regs = (True, False)
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[1].hcode, op[0], rex)
                    + bytearray([0x21, 0xC0 | op[1].lcode << 3 | op[0].lcode]),
                )
            )
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[0].hcode, op[1], rex)
                    + bytearray([0x23, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
            self.in_regs = (True, True)
            self.out_regs = (True, False)
            ...
            if is_imm8(self.operands[1], ext_size=8):
                self.encodings.append(
                    (
                        0x00,
                        lambda op: bytearray(
                            [0x48 | op[0].hcode, 0x83, 0xE0 | op[0].lcode, op[1] & 0xFF]
                        ),
                    )
                )
            if is_rax(self.operands[0]):
            ...
            self.encodings.append(
                (
                    ...
                    + bytearray([0x80])
                    + modrm_sib_disp(4, op[0].address, sib, min_disp)
                    + bytearray([op[1] & 0xFF]),
                )
            )
            self.in_regs = (True, False)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * OR(r8/m8, r8)
        ...
        if is_r8(self.operands[0]) and is_imm(self.operands[1]):
            ...
            if is_al(self.operands[0]):
                self.encodings.append(
                    (0x01, lambda op: bytearray([0x0C, op[1] & 0xFF]))
                )
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0x80, 0xC8 | op[0].lcode, op[1] & 0xFF]),
                )
            )
            self.in_regs = (True, False)
            self.out_regs = (True, False)
            ...
            self.encodings.append(
                (
                    ...
                    + bytearray([0x08, 0xC0 | op[1].lcode << 3 | op[0].lcode]),
                )
            )
            self.encodings.append(
                (
                    ...
                    + bytearray([0x0A, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
            self.in_regs = (True, True)
            self.out_regs = (True, False)
            ...
            if is_imm8(self.operands[1], ext_size=2):
                self.encodings.append(
                    (
                        ...
                        lambda op, rex=False: bytearray([0x66])
                        + optional_rex(0, op[0], rex)
                        + bytearray([0x83, 0xC8 | op[0].lcode, op[1] & 0xFF]),
                    )
                )
            if is_ax(self.operands[0]):
                self.encodings.append(
                    (
                        0x01,
                        lambda op: bytearray(
                            [0x66, 0x0D, op[1] & 0xFF, (op[1] >> 8) & 0xFF]
                        ),
                    )
                )
            self.encodings.append(
                (
                    ...
                    + optional_rex(0, op[0], rex)
                    + bytearray(
                        [0x81, 0xC8 | op[0].lcode, op[1] & 0xFF, (op[1] >> 8) & 0xFF]
                    ),
                )
            )
            self.in_regs = (True, False)
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[1].hcode, op[0], rex)
                    + bytearray([0x09, 0xC0 | op[1].lcode << 3 | op[0].lcode]),
                )
            )
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[0].hcode, op[1], rex)
                    + bytearray([0x0B, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
            self.in_regs = (True, True)
            self.out_regs = (True, False)
            ...
            if is_imm8(self.operands[1], ext_size=8):
                self.encodings.append(
                    (
                        0x00,
                        lambda op: bytearray(
                            [0x48 | op[0].hcode, 0x83, 0xC8 | op[0].lcode, op[1] & 0xFF]
                        ),
                    )
                )
            if is_rax(self.operands[0]):
            ...
            self.encodings.append(
                (
                    ...
                    + bytearray([0x80])
                    + modrm_sib_disp(1, op[0].address, sib, min_disp)
                    + bytearray([op[1] & 0xFF]),
                )
            )
            self.in_regs = (True, False)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * XOR(r8/m8, r8)
        ...
        if is_r8(self.operands[0]) and is_imm(self.operands[1]):
            ...
            if is_al(self.operands[0]):
                self.encodings.append(
                    (0x01, lambda op: bytearray([0x34, op[1] & 0xFF]))
                )
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0x80, 0xF0 | op[0].lcode, op[1] & 0xFF]),
                )
            )
            self.in_regs = (True, False)
            self.out_regs = (True, False)
            ...
            self.encodings.append(
                (
                    ...
                    + bytearray([0x30, 0xC0 | op[1].lcode << 3 | op[0].lcode]),
                )
            )
            self.encodings.append(
                (
                    ...
                    + bytearray([0x32, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
            self.in_regs = (True, True)
            self.out_regs = (True, False)
            ...
            if is_imm8(self.operands[1], ext_size=2):
                self.encodings.append(
                    (
                        ...
                        lambda op, rex=False: bytearray([0x66])
                        + optional_rex(0, op[0], rex)
                        + bytearray([0x83, 0xF0 | op[0].lcode, op[1] & 0xFF]),
                    )
                )
            if is_ax(self.operands[0]):
                self.encodings.append(
                    (
                        0x01,
                        lambda op: bytearray(
                            [0x66, 0x35, op[1] & 0xFF, (op[1] >> 8) & 0xFF]
                        ),
                    )
                )
            self.encodings.append(
                (
                    ...
                    + optional_rex(0, op[0], rex)
                    + bytearray(
                        [0x81, 0xF0 | op[0].lcode, op[1] & 0xFF, (op[1] >> 8) & 0xFF]
                    ),
                )
            )
            self.in_regs = (True, False)
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[1].hcode, op[0], rex)
                    + bytearray([0x31, 0xC0 | op[1].lcode << 3 | op[0].lcode]),
                )
            )
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[0].hcode, op[1], rex)
                    + bytearray([0x33, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
            self.in_regs = (True, True)
            self.out_regs = (True, False)
            ...
            if is_imm8(self.operands[1], ext_size=8):
                self.encodings.append(
                    (
                        0x00,
                        lambda op: bytearray(
                            [0x48 | op[0].hcode, 0x83, 0xF0 | op[0].lcode, op[1] & 0xFF]
                        ),
                    )
                )
            if is_rax(self.operands[0]):
            ...
            self.encodings.append(
                (
                    ...
                    + bytearray([0x80])
                    + modrm_sib_disp(6, op[0].address, sib, min_disp)
                    + bytearray([op[1] & 0xFF]),
                )
            )
            self.in_regs = (True, False)
...
class ANDN(Instruction):
    ...
    def __init__(self, *args, **kwargs):
        ...
        * ANDN(r64, r64, r64/m64)    [BMI]
        ...
        self.isa_extensions = frozenset([nervapy.x86_64.isa.bmi])
        if (
            is_r32(self.operands[0])
            and is_r32(self.operands[1])
            and is_r32(self.operands[2])
        ):
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, sib=False, min_disp=0: vex3(
                        0xC4, 0b10, 0x00, op[0].hcode, op[2].address, op[1].hlcode
                    )
                    + bytearray([0xF2])
            ...
            is_r64(self.operands[0])
            and is_r64(self.operands[1])
            and is_r64(self.operands[2])
        ):
            ...
            self.encodings.append(
                (
                    0x10,
                    lambda op, sib=False, min_disp=0: vex3(
                        0xC4, 0b10, 0x80, op[0].hcode, op[2].address, op[1].hlcode
                    )
                    + bytearray([0xF2])
                    + modrm_sib_disp(op[0].lcode, op[2].address, sib, min_disp),
                )
        ...
        if is_r8(self.operands[0]):
            ...
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0xF6, 0xD0 | op[0].lcode]),
                )
            )
            self.out_regs = (True,)
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(0, op[0], rex)
                    + bytearray([0xF7, 0xD0 | op[0].lcode]),
                )
            )
            self.out_regs = (True,)
            ...
            self.encodings.append(
                (
                    0x00,
                    lambda op: bytearray(
                        [0x48 | op[0].hcode, 0xF7, 0xD0 | op[0].lcode]
                    ),
                )
            )
            self.out_regs = (True,)
        ...
        if is_r8(self.operands[0]):
            ...
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0xF6, 0xD8 | op[0].lcode]),
                )
            )
            self.out_regs = (True,)
        elif is_r16(self.operands[0]):
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(0, op[0], rex)
                    + bytearray([0xF7, 0xD8 | op[0].lcode]),
                )
            )
            self.out_regs = (True,)
        elif is_r32(self.operands[0]):
            ...
            self.encodings.append(
                (
                    0x00,
                    lambda op: bytearray(
                        [0x48 | op[0].hcode, 0xF7, 0xD8 | op[0].lcode]
                    ),
                )
            )
            self.out_regs = (True,)
        ...
        if is_r8(self.operands[0]):
            ...
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0xFE, 0xC0 | op[0].lcode]),
                )
            )
            self.out_regs = (True,)
        elif is_r16(self.operands[0]):
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(0, op[0], rex)
                    + bytearray([0xFF, 0xC0 | op[0].lcode]),
                )
            )
            self.out_regs = (True,)
        elif is_r32(self.operands[0]):
            ...
            self.encodings.append(
                (
                    0x00,
                    lambda op: bytearray(
                        [0x48 | op[0].hcode, 0xFF, 0xC0 | op[0].lcode]
                    ),
                )
            )
            self.out_regs = (True,)
        ...
        if is_r8(self.operands[0]):
            ...
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0xFE, 0xC8 | op[0].lcode]),
                )
            )
            self.out_regs = (True,)
        elif is_r16(self.operands[0]):
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(0, op[0], rex)
                    + bytearray([0xFF, 0xC8 | op[0].lcode]),
                )
            )
            self.out_regs = (True,)
        elif is_r32(self.operands[0]):
            ...
            self.encodings.append(
                (
                    0x00,
                    lambda op: bytearray(
                        [0x48 | op[0].hcode, 0xFF, 0xC8 | op[0].lcode]
                    ),
                )
            )
            self.out_regs = (True,)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * TEST(r8/m8, r8)
        ...
        if is_r8(self.operands[0]) and is_imm(self.operands[1]):
            ...
            if is_al(self.operands[0]):
                self.encodings.append(
                    (0x01, lambda op: bytearray([0xA8, op[1] & 0xFF]))
                )
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0xF6, 0xC0 | op[0].lcode, op[1] & 0xFF]),
                )
            )
            self.in_regs = (True, False)
        elif is_r8(self.operands[0]) and is_r8(self.operands[1]):
            ...
            self.encodings.append(
                (
                    ...
                    + bytearray([0x84, 0xC0 | op[1].lcode << 3 | op[0].lcode]),
                )
            )
            self.in_regs = (True, True)
        elif is_r16(self.operands[0]) and is_imm(self.operands[1]):
            ...
            if is_ax(self.operands[0]):
                self.encodings.append(
                    (
                        0x01,
                        lambda op: bytearray(
                            [0x66, 0xA9, op[1] & 0xFF, (op[1] >> 8) & 0xFF]
                        ),
                    )
                )
            self.encodings.append(
                (
                    ...
                    + optional_rex(0, op[0], rex)
                    + bytearray(
                        [0xF7, 0xC0 | op[0].lcode, op[1] & 0xFF, (op[1] >> 8) & 0xFF]
                    ),
                )
            )
            self.in_regs = (True, False)
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[1].hcode, op[0], rex)
                    + bytearray([0x85, 0xC0 | op[1].lcode << 3 | op[0].lcode]),
                )
            )
            self.in_regs = (True, True)
        elif is_r32(self.operands[0]) and is_imm(self.operands[1]):
    ...
    def __init__(self, *args, **kwargs):
        ...
        * CMP(r8/m8, r8)
        ...
        if is_r8(self.operands[0]) and is_imm(self.operands[1]):
            ...
            if is_al(self.operands[0]):
                self.encodings.append(
                    (0x01, lambda op: bytearray([0x3C, op[1] & 0xFF]))
                )
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0x80, 0xF8 | op[0].lcode, op[1] & 0xFF]),
                )
            )
            self.in_regs = (True, False)
        elif is_r8(self.operands[0]) and is_r8(self.operands[1]):
            ...
            self.encodings.append(
                (
                    ...
                    + bytearray([0x38, 0xC0 | op[1].lcode << 3 | op[0].lcode]),
                )
            )
            self.encodings.append(
                (
                    ...
                    + bytearray([0x3A, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
            self.in_regs = (True, True)
            self._cancelling_inputs = True
            ...
            if is_imm8(self.operands[1], ext_size=2):
                self.encodings.append(
                    (
                        ...
                        lambda op, rex=False: bytearray([0x66])
                        + optional_rex(0, op[0], rex)
                        + bytearray([0x83, 0xF8 | op[0].lcode, op[1] & 0xFF]),
                    )
                )
            if is_ax(self.operands[0]):
                self.encodings.append(
                    (
                        0x01,
                        lambda op: bytearray(
                            [0x66, 0x3D, op[1] & 0xFF, (op[1] >> 8) & 0xFF]
                        ),
                    )
                )
            self.encodings.append(
                (
                    ...
                    + optional_rex(0, op[0], rex)
                    + bytearray(
                        [0x81, 0xF8 | op[0].lcode, op[1] & 0xFF, (op[1] >> 8) & 0xFF]
                    ),
                )
            )
            self.in_regs = (True, False)
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[1].hcode, op[0], rex)
                    + bytearray([0x39, 0xC0 | op[1].lcode << 3 | op[0].lcode]),
                )
            )
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[0].hcode, op[1], rex)
                    + bytearray([0x3B, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
            self.in_regs = (True, True)
            self._cancelling_inputs = True
            ...
            if is_imm8(self.operands[1], ext_size=8):
                self.encodings.append(
                    (
                        0x00,
                        lambda op: bytearray(
                            [0x48 | op[0].hcode, 0x83, 0xF8 | op[0].lcode, op[1] & 0xFF]
                        ),
                    )
                )
            if is_rax(self.operands[0]):
            ...
            self.encodings.append(
                (
                    ...
                    + bytearray([0x80])
                    + modrm_sib_disp(7, op[0].address, sib, min_disp)
                    + bytearray([op[1] & 0xFF]),
                )
            )
            self.in_regs = (True, False)
        ...
        if is_r8(self.operands[0]) and is_imm(self.operands[1]):
            ...
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0xC6, 0xC0 | op[0].lcode, op[1] & 0xFF]),
                )
            )
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0xB0 | op[0].lcode, op[1] & 0xFF]),
                )
            )
            ...
            self.encodings.append(
                (
                    ...
                    + bytearray([0x88, 0xC0 | op[1].lcode << 3 | op[0].lcode]),
                )
            )
            self.encodings.append(
                (
                    ...
                    + bytearray([0x8A, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
            ...
            self.encodings.append(
                (
                    ...
                    + optional_rex(0, op[0], rex)
                    + bytearray(
                        [0xC7, 0xC0 | op[0].lcode, op[1] & 0xFF, (op[1] >> 8) & 0xFF]
                    ),
                )
            )
            self.encodings.append(
                (
                    ...
                    + optional_rex(0, op[0], rex)
                    + bytearray(
                        [0xB8 | op[0].lcode, op[1] & 0xFF, (op[1] >> 8) & 0xFF]
                    ),
                )
            )
            self.in_regs = (False, False)
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[1].hcode, op[0], rex)
                    + bytearray([0x89, 0xC0 | op[1].lcode << 3 | op[0].lcode]),
                )
            )
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[0].hcode, op[1], rex)
                    + bytearray([0x8B, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
            self.in_regs = (False, True)
            self.out_regs = (True, False)
        ...
        if is_r16(self.operands[0]) and is_r8(self.operands[1]):
            ...
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[0].hcode, op[1], rex or is_r8rex(op[1]))
                    + bytearray([0x0F, 0xB6, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
            ...
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(
                        op[0].hcode, op[1], rex or is_r8rex(op[1])
                    )
                    + bytearray([0x0F, 0xB6, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
            ...
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(op[0].hcode, op[1], rex)
                    + bytearray([0x0F, 0xB7, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
        ...
        if is_r16(self.operands[0]) and is_r8(self.operands[1]):
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[0].hcode, op[1], rex or is_r8rex(op[1]))
                    + bytearray([0x0F, 0xBE, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
        elif is_r16(self.operands[0]) and is_m8(self.operands[1]):
            self.go_name = "MOVBWSX"
            ...
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(op[0].hcode, op[1], rex)
                    + bytearray([0x0F, 0xBF, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
        elif is_r32(self.operands[0]) and is_m8(self.operands[1]):
            self.go_name = "MOVBLSX"
...
class MOVBE(Instruction):
    ...
    def __init__(self, *args, **kwargs):
        ...
        * MOVBE(r64, m64)    [MOVBE]
        ...
        self.out_operands = (True, False)
        self.isa_extensions = frozenset([nervapy.x86_64.isa.movbe])
...
class MOVNTI(Instruction):
    ...
    def __init__(self, *args, **kwargs):
        ...
        * MOVNTI(m64, r64)    [SSE2]
        ...
        self.out_regs = (False, False)
        self.out_operands = (True, False)
        self.isa_extensions = frozenset([nervapy.x86_64.isa.sse2])
        ...
        if is_r16(self.operands[0]) and is_imm(self.operands[1]):
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(0, op[0], rex)
                    + bytearray([0x0F, 0xBA, 0xE0 | op[0].lcode, op[1] & 0xFF]),
                )
            )
            self.in_regs = (True, False)
        elif is_r16(self.operands[0]) and is_r16(self.operands[1]):
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[1].hcode, op[0], rex)
                    + bytearray([0x0F, 0xA3, 0xC0 | op[1].lcode << 3 | op[0].lcode]),
                )
            )
            self.in_regs = (True, True)
        elif is_r32(self.operands[0]) and is_imm(self.operands[1]):
        ...
        if is_r16(self.operands[0]) and is_imm(self.operands[1]):
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(0, op[0], rex)
                    + bytearray([0x0F, 0xBA, 0xE8 | op[0].lcode, op[1] & 0xFF]),
                )
            )
            self.in_regs = (True, False)
            self.out_regs = (True, False)
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[1].hcode, op[0], rex)
                    + bytearray([0x0F, 0xAB, 0xC0 | op[1].lcode << 3 | op[0].lcode]),
                )
            )
            self.in_regs = (True, True)
            self.out_regs = (True, False)
        ...
        if is_r16(self.operands[0]) and is_imm(self.operands[1]):
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(0, op[0], rex)
                    + bytearray([0x0F, 0xBA, 0xF0 | op[0].lcode, op[1] & 0xFF]),
                )
            )
            self.in_regs = (True, False)
            self.out_regs = (True, False)
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[1].hcode, op[0], rex)
                    + bytearray([0x0F, 0xB3, 0xC0 | op[1].lcode << 3 | op[0].lcode]),
                )
            )
            self.in_regs = (True, True)
            self.out_regs = (True, False)
        ...
        if is_r16(self.operands[0]) and is_imm(self.operands[1]):
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(0, op[0], rex)
                    + bytearray([0x0F, 0xBA, 0xF8 | op[0].lcode, op[1] & 0xFF]),
                )
            )
            self.in_regs = (True, False)
            self.out_regs = (True, False)
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[1].hcode, op[0], rex)
                    + bytearray([0x0F, 0xBB, 0xC0 | op[1].lcode << 3 | op[0].lcode]),
                )
            )
            self.in_regs = (True, True)
            self.out_regs = (True, False)
...
class POPCNT(Instruction):
    ...
    def __init__(self, *args, **kwargs):
        ...
        * POPCNT(r64, r64/m64)    [POPCNT]
        ...
        self.out_regs = (True, False)
        self.out_operands = (True, False)
        self.isa_extensions = frozenset([nervapy.x86_64.isa.popcnt])
        if is_r16(self.operands[0]) and is_r16(self.operands[1]):
            self._gas_name = "popcntw"
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: bytearray([0x66, 0xF3])
                    + optional_rex(op[0].hcode, op[1], rex)
                    + bytearray([0x0F, 0xB8, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
        elif is_r16(self.operands[0]) and is_m16(self.operands[1]):
            self._gas_name = "popcntw"
            self.encodings.append(
                (
                    0x30,
                    lambda op, rex=False, sib=False, min_disp=0: bytearray([0x66, 0xF3])
                    + optional_rex(op[0].hcode, op[1].address, rex)
                    + bytearray([0x0F, 0xB8])
                    + modrm_sib_disp(op[0].lcode, op[1].address, sib, min_disp),
                )
        ...
        if is_r32(self.operands[0]):
            ...
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex)
                    + bytearray([0x0F, 0xC8 | op[0].lcode]),
                )
            )
        elif is_r64(self.operands[0]):
            self.go_name = "BSWAPQ"
            ...
            self.encodings.append(
                (
                    0x00,
                    lambda op: bytearray(
                        [0x48 | op[0].hcode, 0x0F, 0xC8 | op[0].lcode]
                    ),
                )
            )
        else:
            raise SyntaxError(
                "Invalid operand types: BSWAP "
                + ", ".join(map(format_operand_type, self.operands))
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
        ...
        if is_r16(self.operands[0]) and is_r16(self.operands[1]):
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[0].hcode, op[1], rex)
                    + bytearray([0x0F, 0xBC, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
        elif is_r16(self.operands[0]) and is_m16(self.operands[1]):
            self.go_name = "BSFW"
        ...
        if is_r16(self.operands[0]) and is_r16(self.operands[1]):
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[0].hcode, op[1], rex)
                    + bytearray([0x0F, 0xBD, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
        elif is_r16(self.operands[0]) and is_m16(self.operands[1]):
            self.go_name = "BSRW"
...
class LZCNT(Instruction):
    ...
    def __init__(self, *args, **kwargs):
        ...
        * LZCNT(r64, r64/m64)    [LZCNT]
        ...
        self.out_regs = (True, False)
        self.out_operands = (True, False)
        self.isa_extensions = frozenset([nervapy.x86_64.isa.lzcnt])
        if is_r16(self.operands[0]) and is_r16(self.operands[1]):
        ...
        if is_r8(self.operands[0]) and is_imm(self.operands[1]):
            ...
            if self.operands[1] == 1:
                self.encodings.append(
                    (
                        0x20,
                        lambda op, rex=False: optional_rex(
                            0, op[0], rex or is_r8rex(op[0])
                        )
                        + bytearray([0xD0, 0xE8 | op[0].lcode]),
                    )
                )
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0xC0, 0xE8 | op[0].lcode, op[1] & 0xFF]),
                )
            )
            self.in_regs = (True, False)
            self.out_regs = (True, False)
            ...
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0xD2, 0xE8 | op[0].lcode]),
                )
            )
            self.in_regs = (True, True)
            self.out_regs = (True, False)
            ...
            if self.operands[1] == 1:
                self.encodings.append(
                    (
                        ...
                        lambda op, rex=False: bytearray([0x66])
                        + optional_rex(0, op[0], rex)
                        + bytearray([0xD1, 0xE8 | op[0].lcode]),
                    )
                )
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(0, op[0], rex)
                    + bytearray([0xC1, 0xE8 | op[0].lcode, op[1] & 0xFF]),
                )
            )
            self.in_regs = (True, False)
            self.out_regs = (True, False)
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(0, op[0], rex)
                    + bytearray([0xD3, 0xE8 | op[0].lcode]),
                )
            )
            self.in_regs = (True, True)
            self.out_regs = (True, False)
            ...
            if self.operands[1] == 1:
                self.encodings.append(
                    (
                        0x00,
                        lambda op: bytearray(
                            [0x48 | op[0].hcode, 0xD1, 0xE8 | op[0].lcode]
                        ),
                    )
                )
            self.encodings.append(
                (
                    0x00,
                    lambda op: bytearray(
                        [0x48 | op[0].hcode, 0xC1, 0xE8 | op[0].lcode, op[1] & 0xFF]
                    ),
                )
            )
            self.in_regs = (True, False)
            ...
            self.encodings.append(
                (
                    0x00,
                    lambda op: bytearray(
                        [0x48 | op[0].hcode, 0xD3, 0xE8 | op[0].lcode]
                    ),
                )
            )
            self.in_regs = (True, True)
        ...
        if is_r8(self.operands[0]) and is_imm(self.operands[1]):
            ...
            if self.operands[1] == 1:
                self.encodings.append(
                    (
                        ...
                        + bytearray([0xD0, 0xF8 | op[0].lcode]),
                    )
                )
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0xC0, 0xF8 | op[0].lcode, op[1] & 0xFF]),
                )
            )
            self.in_regs = (True, False)
            self.out_regs = (True, False)
            ...
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0xD2, 0xF8 | op[0].lcode]),
                )
            )
            self.in_regs = (True, True)
            self.out_regs = (True, False)
            ...
            if self.operands[1] == 1:
                self.encodings.append(
                    (
                        ...
                        lambda op, rex=False: bytearray([0x66])
                        + optional_rex(0, op[0], rex)
                        + bytearray([0xD1, 0xF8 | op[0].lcode]),
                    )
                )
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(0, op[0], rex)
                    + bytearray([0xC1, 0xF8 | op[0].lcode, op[1] & 0xFF]),
                )
            )
            self.in_regs = (True, False)
            self.out_regs = (True, False)
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(0, op[0], rex)
                    + bytearray([0xD3, 0xF8 | op[0].lcode]),
                )
            )
            self.in_regs = (True, True)
            self.out_regs = (True, False)
            ...
            if self.operands[1] == 1:
                self.encodings.append(
                    (
                        0x00,
                        lambda op: bytearray(
                            [0x48 | op[0].hcode, 0xD1, 0xF8 | op[0].lcode]
                        ),
                    )
                )
            self.encodings.append(
                (
                    0x00,
                    lambda op: bytearray(
                        [0x48 | op[0].hcode, 0xC1, 0xF8 | op[0].lcode, op[1] & 0xFF]
                    ),
                )
            )
            self.in_regs = (True, False)
            ...
            self.encodings.append(
                (
                    0x00,
                    lambda op: bytearray(
                        [0x48 | op[0].hcode, 0xD3, 0xF8 | op[0].lcode]
                    ),
                )
            )
            self.in_regs = (True, True)
        ...
        if is_r8(self.operands[0]) and is_imm(self.operands[1]):
            ...
            if self.operands[1] == 1:
                self.encodings.append(
                    (
                        ...
                        + bytearray([0xD0, 0xE0 | op[0].lcode]),
                    )
                )
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0xC0, 0xE0 | op[0].lcode, op[1] & 0xFF]),
                )
            )
            self.in_regs = (True, False)
            self.out_regs = (True, False)
            ...
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0xD2, 0xE0 | op[0].lcode]),
                )
            )
            self.in_regs = (True, True)
            self.out_regs = (True, False)
            ...
            if self.operands[1] == 1:
                self.encodings.append(
                    (
                        ...
                        lambda op, rex=False: bytearray([0x66])
                        + optional_rex(0, op[0], rex)
                        + bytearray([0xD1, 0xE0 | op[0].lcode]),
                    )
                )
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(0, op[0], rex)
                    + bytearray([0xC1, 0xE0 | op[0].lcode, op[1] & 0xFF]),
                )
            )
            self.in_regs = (True, False)
            self.out_regs = (True, False)
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(0, op[0], rex)
                    + bytearray([0xD3, 0xE0 | op[0].lcode]),
                )
            )
            self.in_regs = (True, True)
            self.out_regs = (True, False)
            ...
            if self.operands[1] == 1:
                self.encodings.append(
                    (
                        0x00,
                        lambda op: bytearray(
                            [0x48 | op[0].hcode, 0xD1, 0xE0 | op[0].lcode]
                        ),
                    )
                )
            self.encodings.append(
                (
                    0x00,
                    lambda op: bytearray(
                        [0x48 | op[0].hcode, 0xC1, 0xE0 | op[0].lcode, op[1] & 0xFF]
                    ),
                )
            )
            self.in_regs = (True, False)
            ...
            self.encodings.append(
                (
                    0x00,
                    lambda op: bytearray(
                        [0x48 | op[0].hcode, 0xD3, 0xE0 | op[0].lcode]
                    ),
                )
            )
            self.in_regs = (True, True)
...
class SHRX(Instruction):
    ...
    def __init__(self, *args, **kwargs):
        ...
        * SHRX(r64, r64/m64, r64)    [BMI2]
        ...
        self.out_regs = (True, False, False)
        self.out_operands = (True, False, False)
        self.isa_extensions = frozenset([nervapy.x86_64.isa.bmi2])
        if (
            is_r32(self.operands[0])
            and is_r32(self.operands[1])
            and is_r32(self.operands[2])
            ...
            self.encodings.append(
                (
                    0x10,
                    lambda op, sib=False, min_disp=0: vex3(
                        0xC4, 0b10, 0x03, op[0].hcode, op[1].address, op[2].hlcode
                    )
                    + bytearray([0xF7])
                    + modrm_sib_disp(op[0].lcode, op[1].address, sib, min_disp),
                )
            ...
            self.encodings.append(
                (
                    0x10,
                    lambda op, sib=False, min_disp=0: vex3(
                        0xC4, 0b10, 0x83, op[0].hcode, op[1].address, op[2].hlcode
                    )
                    + bytearray([0xF7])
                    + modrm_sib_disp(op[0].lcode, op[1].address, sib, min_disp),
                )
        ...
        if (
            ...
            self.encodings.append(
                (
                    0x10,
                    lambda op, sib=False, min_disp=0: vex3(
                        0xC4, 0b10, 0x02, op[0].hcode, op[1].address, op[2].hlcode
                    )
                    + bytearray([0xF7])
                    + modrm_sib_disp(op[0].lcode, op[1].address, sib, min_disp),
                )
            ...
            self.encodings.append(
                (
                    0x10,
                    lambda op, sib=False, min_disp=0: vex3(
                        0xC4, 0b10, 0x82, op[0].hcode, op[1].address, op[2].hlcode
                    )
                    + bytearray([0xF7])
                    + modrm_sib_disp(op[0].lcode, op[1].address, sib, min_disp),
                )
        ...
        if (
            ...
            self.encodings.append(
                (
                    0x10,
                    lambda op, sib=False, min_disp=0: vex3(
                        0xC4, 0b10, 0x01, op[0].hcode, op[1].address, op[2].hlcode
                    )
                    + bytearray([0xF7])
                    + modrm_sib_disp(op[0].lcode, op[1].address, sib, min_disp),
                )
            ...
            self.encodings.append(
                (
                    0x10,
                    lambda op, sib=False, min_disp=0: vex3(
                        0xC4, 0b10, 0x81, op[0].hcode, op[1].address, op[2].hlcode
                    )
                    + bytearray([0xF7])
                    + modrm_sib_disp(op[0].lcode, op[1].address, sib, min_disp),
                )
...
class SHRD(Instruction):
    ...
    def __init__(self, *args, **kwargs):
        ...
        * SHRD(r64/m64, r64, imm8)
        ...
        self.out_operands = (True, False, False)
        if (
            is_r16(self.operands[0])
            and is_r16(self.operands[1])
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[1].hcode, op[0], rex)
                    + bytearray([0x0F, 0xAD, 0xC0 | op[1].lcode << 3 | op[0].lcode]),
                )
            )
        ...
        if (
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[1].hcode, op[0], rex)
                    + bytearray([0x0F, 0xA5, 0xC0 | op[1].lcode << 3 | op[0].lcode]),
                )
            )
            self.in_regs = (True, True, True)
            self.out_regs = (True, False, False)
        ...
        if is_r8(self.operands[0]) and is_imm(self.operands[1]):
            ...
            if self.operands[1] == 1:
                self.encodings.append(
                    (
                        ...
                        + bytearray([0xD0, 0xC8 | op[0].lcode]),
                    )
                )
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0xC0, 0xC8 | op[0].lcode, op[1] & 0xFF]),
                )
            )
            self.in_regs = (True, False)
            self.out_regs = (True, False)
            ...
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0xD2, 0xC8 | op[0].lcode]),
                )
            )
            self.in_regs = (True, True)
            self.out_regs = (True, False)
            ...
            if self.operands[1] == 1:
                self.encodings.append(
                    (
                        ...
                        lambda op, rex=False: bytearray([0x66])
                        + optional_rex(0, op[0], rex)
                        + bytearray([0xD1, 0xC8 | op[0].lcode]),
                    )
                )
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(0, op[0], rex)
                    + bytearray([0xC1, 0xC8 | op[0].lcode, op[1] & 0xFF]),
                )
            )
            self.in_regs = (True, False)
            self.out_regs = (True, False)
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(0, op[0], rex)
                    + bytearray([0xD3, 0xC8 | op[0].lcode]),
                )
            )
            self.in_regs = (True, True)
            self.out_regs = (True, False)
            ...
            if self.operands[1] == 1:
                self.encodings.append(
                    (
                        0x00,
                        lambda op: bytearray(
                            [0x48 | op[0].hcode, 0xD1, 0xC8 | op[0].lcode]
                        ),
                    )
                )
            self.encodings.append(
                (
                    0x00,
                    lambda op: bytearray(
                        [0x48 | op[0].hcode, 0xC1, 0xC8 | op[0].lcode, op[1] & 0xFF]
                    ),
                )
            )
            self.in_regs = (True, False)
            ...
            self.encodings.append(
                (
                    0x00,
                    lambda op: bytearray(
                        [0x48 | op[0].hcode, 0xD3, 0xC8 | op[0].lcode]
                    ),
                )
            )
            self.in_regs = (True, True)
        ...
        if is_r8(self.operands[0]) and is_imm(self.operands[1]):
            ...
            if self.operands[1] == 1:
                self.encodings.append(
                    (
                        ...
                        + bytearray([0xD0, 0xC0 | op[0].lcode]),
                    )
                )
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0xC0, 0xC0 | op[0].lcode, op[1] & 0xFF]),
                )
            )
            self.in_regs = (True, False)
            self.out_regs = (True, False)
            ...
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0xD2, 0xC0 | op[0].lcode]),
                )
            )
            self.in_regs = (True, True)
            self.out_regs = (True, False)
            ...
            if self.operands[1] == 1:
                self.encodings.append(
                    (
                        ...
                        lambda op, rex=False: bytearray([0x66])
                        + optional_rex(0, op[0], rex)
                        + bytearray([0xD1, 0xC0 | op[0].lcode]),
                    )
                )
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(0, op[0], rex)
                    + bytearray([0xC1, 0xC0 | op[0].lcode, op[1] & 0xFF]),
                )
            )
            self.in_regs = (True, False)
            self.out_regs = (True, False)
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(0, op[0], rex)
                    + bytearray([0xD3, 0xC0 | op[0].lcode]),
                )
            )
            self.in_regs = (True, True)
            self.out_regs = (True, False)
            ...
            if self.operands[1] == 1:
                self.encodings.append(
                    (
                        0x00,
                        lambda op: bytearray(
                            [0x48 | op[0].hcode, 0xD1, 0xC0 | op[0].lcode]
                        ),
                    )
                )
            self.encodings.append(
                (
                    0x00,
                    lambda op: bytearray(
                        [0x48 | op[0].hcode, 0xC1, 0xC0 | op[0].lcode, op[1] & 0xFF]
                    ),
                )
            )
            self.in_regs = (True, False)
            ...
            self.encodings.append(
                (
                    0x00,
                    lambda op: bytearray(
                        [0x48 | op[0].hcode, 0xD3, 0xC0 | op[0].lcode]
                    ),
                )
            )
            self.in_regs = (True, True)
        ...
        if (
            ...
            self.encodings.append(
                (
                    0x10,
                    lambda op, sib=False, min_disp=0: vex3(
                        0xC4, 0b11, 0x03, op[0].hcode, op[1].address
                    )
                    + bytearray([0xF0])
                    + modrm_sib_disp(op[0].lcode, op[1].address, sib, min_disp)
                    + bytearray([op[2] & 0xFF]),
            ...
            self.encodings.append(
                (
                    0x10,
                    lambda op, sib=False, min_disp=0: vex3(
                        0xC4, 0b11, 0x83, op[0].hcode, op[1].address
                    )
                    + bytearray([0xF0])
                    + modrm_sib_disp(op[0].lcode, op[1].address, sib, min_disp)
                    + bytearray([op[2] & 0xFF]),
        ...
        if is_r8(self.operands[0]) and is_imm(self.operands[1]):
            ...
            if self.operands[1] == 1:
                self.encodings.append(
                    (
                        ...
                        + bytearray([0xD0, 0xD8 | op[0].lcode]),
                    )
                )
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0xC0, 0xD8 | op[0].lcode, op[1] & 0xFF]),
                )
            )
            self.in_regs = (True, False)
            self.out_regs = (True, False)
            ...
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0xD2, 0xD8 | op[0].lcode]),
                )
            )
            self.in_regs = (True, True)
            self.out_regs = (True, False)
            ...
            if self.operands[1] == 1:
                self.encodings.append(
                    (
                        ...
                        lambda op, rex=False: bytearray([0x66])
                        + optional_rex(0, op[0], rex)
                        + bytearray([0xD1, 0xD8 | op[0].lcode]),
                    )
                )
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(0, op[0], rex)
                    + bytearray([0xC1, 0xD8 | op[0].lcode, op[1] & 0xFF]),
                )
            )
            self.in_regs = (True, False)
            self.out_regs = (True, False)
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(0, op[0], rex)
                    + bytearray([0xD3, 0xD8 | op[0].lcode]),
                )
            )
            self.in_regs = (True, True)
            self.out_regs = (True, False)
            ...
            if self.operands[1] == 1:
                self.encodings.append(
                    (
                        0x00,
                        lambda op: bytearray(
                            [0x48 | op[0].hcode, 0xD1, 0xD8 | op[0].lcode]
                        ),
                    )
                )
            self.encodings.append(
                (
                    0x00,
                    lambda op: bytearray(
                        [0x48 | op[0].hcode, 0xC1, 0xD8 | op[0].lcode, op[1] & 0xFF]
                    ),
                )
            )
            self.in_regs = (True, False)
            ...
            self.encodings.append(
                (
                    0x00,
                    lambda op: bytearray(
                        [0x48 | op[0].hcode, 0xD3, 0xD8 | op[0].lcode]
                    ),
                )
            )
            self.in_regs = (True, True)
        ...
        if is_r8(self.operands[0]) and is_imm(self.operands[1]):
            ...
            if self.operands[1] == 1:
                self.encodings.append(
                    (
                        ...
                        + bytearray([0xD0, 0xD0 | op[0].lcode]),
                    )
                )
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0xC0, 0xD0 | op[0].lcode, op[1] & 0xFF]),
                )
            )
            self.in_regs = (True, False)
            self.out_regs = (True, False)
            ...
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0xD2, 0xD0 | op[0].lcode]),
                )
            )
            self.in_regs = (True, True)
            self.out_regs = (True, False)
            ...
            if self.operands[1] == 1:
                self.encodings.append(
                    (
                        ...
                        lambda op, rex=False: bytearray([0x66])
                        + optional_rex(0, op[0], rex)
                        + bytearray([0xD1, 0xD0 | op[0].lcode]),
                    )
                )
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(0, op[0], rex)
                    + bytearray([0xC1, 0xD0 | op[0].lcode, op[1] & 0xFF]),
                )
            )
            self.in_regs = (True, False)
            self.out_regs = (True, False)
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(0, op[0], rex)
                    + bytearray([0xD3, 0xD0 | op[0].lcode]),
                )
            )
            self.in_regs = (True, True)
            self.out_regs = (True, False)
            ...
            if self.operands[1] == 1:
                self.encodings.append(
                    (
                        0x00,
                        lambda op: bytearray(
                            [0x48 | op[0].hcode, 0xD1, 0xD0 | op[0].lcode]
                        ),
                    )
                )
            self.encodings.append(
                (
                    0x00,
                    lambda op: bytearray(
                        [0x48 | op[0].hcode, 0xC1, 0xD0 | op[0].lcode, op[1] & 0xFF]
                    ),
                )
            )
            self.in_regs = (True, False)
            ...
            self.encodings.append(
                (
                    0x00,
                    lambda op: bytearray(
                        [0x48 | op[0].hcode, 0xD3, 0xD0 | op[0].lcode]
                    ),
                )
            )
            self.in_regs = (True, True)
            ...
            if is_r8(self.operands[0]):
                ...
                self.encodings.append(
                    (
                        ...
                        + bytearray([0xF6, 0xE8 | op[0].lcode]),
                    )
                )
                ...
                self.encodings.append(
                    (
                        ...
                        lambda op, rex=False: bytearray([0x66])
                        + optional_rex(0, op[0], rex)
                        + bytearray([0xF7, 0xE8 | op[0].lcode]),
                    )
                )
                ...
                self.encodings.append(
                    (
                        0x00,
                        lambda op: bytearray(
                            [0x48 | op[0].hcode, 0xF7, 0xE8 | op[0].lcode]
                        ),
                    )
                )
            ...
            if is_r16(self.operands[0]) and is_r16(self.operands[1]):
                ...
                self.encodings.append(
                    (
                        ...
                        + optional_rex(op[0].hcode, op[1], rex)
                        + bytearray(
                            [0x0F, 0xAF, 0xC0 | op[0].lcode << 3 | op[1].lcode]
                        ),
                    )
                )
            elif is_r16(self.operands[0]) and is_m16(self.operands[1]):
                ...
                self.encodings.append(
                    (
                        0x10,
                        lambda op, sib=False, min_disp=0: rex(
                            1, op[0].hcode, op[1].address
                        )
                        + bytearray([0x0F, 0xAF])
                        + modrm_sib_disp(op[0].lcode, op[1].address, sib, min_disp),
                    )
            ...
            if (
                ...
                if is_imm8(self.operands[2]):
                    self.encodings.append(
                        (
                            0x30,
                            lambda op, rex=False, sib=False, min_disp=0: bytearray(
                                [0x66]
                            )
                            + optional_rex(op[0].hcode, op[1].address, rex)
                            + bytearray([0x6B])
                ...
                self.encodings.append(
                    (
                        ...
                        + bytearray([0x69])
                        + modrm_sib_disp(op[0].lcode, op[1].address, sib, min_disp)
                        + bytearray([op[2] & 0xFF, (op[2] >> 8) & 0xFF]),
                    )
                )
            elif (
                is_r32(self.operands[0])
        ...
        if is_r8(self.operands[0]):
            ...
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0xF6, 0xE0 | op[0].lcode]),
                )
            )
            self._implicit_in_regs = {0: 1}
            self._implicit_out_regs = {0: 3}
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(0, op[0], rex)
                    + bytearray([0xF7, 0xE0 | op[0].lcode]),
                )
            )
            self._implicit_in_regs = {0: 3}
            self._implicit_out_regs = {0: 3, 2: 3}
            ...
            self.encodings.append(
                (
                    0x00,
                    lambda op: bytearray(
                        [0x48 | op[0].hcode, 0xF7, 0xE0 | op[0].lcode]
                    ),
                )
            )
            self._implicit_in_regs = {0: 15}
        ...
        if (
            ...
            self.encodings.append(
                (
                    0x10,
                    lambda op, sib=False, min_disp=0: vex3(
                        0xC4, 0b10, 0x03, op[0].hcode, op[2].address, op[1].hlcode
                    )
                    + bytearray([0xF6])
                    + modrm_sib_disp(op[0].lcode, op[2].address, sib, min_disp),
                )
            ...
            self.encodings.append(
                (
                    0x10,
                    lambda op, sib=False, min_disp=0: vex3(
                        0xC4, 0b10, 0x83, op[0].hcode, op[2].address, op[1].hlcode
                    )
                    + bytearray([0xF6])
                    + modrm_sib_disp(op[0].lcode, op[2].address, sib, min_disp),
                )
        ...
        if is_r8(self.operands[0]):
            ...
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0xF6, 0xF8 | op[0].lcode]),
                )
            )
            self._implicit_in_regs = {0: 3}
            self._implicit_out_regs = {0: 3}
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(0, op[0], rex)
                    + bytearray([0xF7, 0xF8 | op[0].lcode]),
                )
            )
            ...
            self.encodings.append(
                (
                    0x00,
                    lambda op: bytearray(
                        [0x48 | op[0].hcode, 0xF7, 0xF8 | op[0].lcode]
                    ),
                )
            )
        ...
        if is_r8(self.operands[0]):
            ...
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0xF6, 0xF0 | op[0].lcode]),
                )
            )
            self._implicit_in_regs = {0: 3}
            self._implicit_out_regs = {0: 3}
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(0, op[0], rex)
                    + bytearray([0xF7, 0xF0 | op[0].lcode]),
                )
            )
            self._implicit_in_regs = {0: 3, 2: 3}
            self._implicit_out_regs = {0: 3, 2: 3}
            ...
            self.encodings.append(
                (
                    0x00,
                    lambda op: bytearray(
                        [0x48 | op[0].hcode, 0xF7, 0xF0 | op[0].lcode]
                    ),
                )
            )
            self._implicit_in_regs = {0: 15, 2: 15}
        ...
        * PUSH(r64/m64)
        ...
        if is_imm(self.operands[0]):
            ...
            if is_imm8(self.operands[0], ext_size=8):
                self.encodings.append(
                    (0x00, lambda op: bytearray([0x6A, op[0] & 0xFF]))
                )
            self.encodings.append(
                (
                    0x00,
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(0, op[0], rex)
                    + bytearray([0xFF, 0xF0 | op[0].lcode]),
                )
            )
            self.in_regs = (True,)
        elif is_r64(self.operands[0]):
        ...
        if is_r16(self.operands[0]):
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(0, op[0], rex)
                    + bytearray([0x8F, 0xC0 | op[0].lcode]),
                )
            )
            self.in_regs = (False,)
            self.out_regs = (True,)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * BEXTR(r64, r64/m64, r64)      [BMI]
        ...
        if (
            ...
            self.encodings.append(
                (
                    ...
                    lambda op: bytearray(
                        [
                            0x8F,
                            0xEA ^ (op[0].hcode << 7) ^ (op[1].hcode << 5),
                            0x78,
                            0x10,
                            0xC0 | op[0].lcode << 3 | op[1].lcode,
                            op[2] & 0xFF,
            ...
            self.in_regs = (False, True, False)
            self.isa_extensions = frozenset([nervapy.x86_64.isa.tbm])
        elif (
            is_r32(self.operands[0])
            and is_m32(self.operands[1])
            and is_imm(self.operands[2])
            ...
            self.encodings.append(
                (
                    0x10,
                    lambda op, sib=False, min_disp=0: vex3(
                        0x8F, 0b1010, 0x00, op[0].hcode, op[1].address
                    )
                    + bytearray([0x10])
                    + modrm_sib_disp(op[0].lcode, op[1].address, sib, min_disp)
                    + bytearray(
            ...
            self.encodings.append(
                (
                    0x10,
                    lambda op, sib=False, min_disp=0: vex3(
                        0x8F, 0b1010, 0x80, op[0].hcode, op[1].address
                    )
                    + bytearray([0x10])
                    + modrm_sib_disp(op[0].lcode, op[1].address, sib, min_disp)
                    + bytearray(
            ...
            self.encodings.append(
                (
                    0x10,
                    lambda op, sib=False, min_disp=0: vex3(
                        0xC4, 0b10, 0x00, op[0].hcode, op[1].address, op[2].hlcode
                    )
                    + bytearray([0xF7])
                    + modrm_sib_disp(op[0].lcode, op[1].address, sib, min_disp),
                )
            ...
            self.encodings.append(
                (
                    0x10,
                    lambda op, sib=False, min_disp=0: vex3(
                        0xC4, 0b10, 0x80, op[0].hcode, op[1].address, op[2].hlcode
                    )
                    + bytearray([0xF7])
                    + modrm_sib_disp(op[0].lcode, op[1].address, sib, min_disp),
                )
        ...
        if (
            ...
            self.encodings.append(
                (
                    0x10,
                    lambda op, sib=False, min_disp=0: vex3(
                        0xC4, 0b10, 0x02, op[0].hcode, op[2].address, op[1].hlcode
                    )
                    + bytearray([0xF5])
                    + modrm_sib_disp(op[0].lcode, op[2].address, sib, min_disp),
                )
            ...
            self.encodings.append(
                (
                    0x10,
                    lambda op, sib=False, min_disp=0: vex3(
                        0xC4, 0b10, 0x82, op[0].hcode, op[2].address, op[1].hlcode
                    )
                    + bytearray([0xF5])
                    + modrm_sib_disp(op[0].lcode, op[2].address, sib, min_disp),
                )
        ...
        if is_r32(self.operands[0]) and is_r32(self.operands[1]):
            ...
            self.encodings.append(
                (
                    0x10,
                    lambda op, sib=False, min_disp=0: vex3(
                        0x8F, 0b1001, 0x00, 0, op[1].address, op[0].hlcode
                    )
                    + bytearray([0x01])
                    + modrm_sib_disp(1, op[1].address, sib, min_disp),
                )
            )
        elif is_r64(self.operands[0]) and is_r64(self.operands[1]):
            self.encodings.append(
            ...
            self.encodings.append(
                (
                    0x10,
                    lambda op, sib=False, min_disp=0: vex3(
                        0x8F, 0b1001, 0x80, 0, op[1].address, op[0].hlcode
                    )
                    + bytearray([0x01])
                    + modrm_sib_disp(1, op[1].address, sib, min_disp),
                )
        ...
        if is_r32(self.operands[0]) and is_r32(self.operands[1]):
            ...
            self.encodings.append(
                (
                    ...
                    + bytearray([0x02])
                    + modrm_sib_disp(6, op[1].address, sib, min_disp),
                )
            )
        elif is_r64(self.operands[0]) and is_r64(self.operands[1]):
            self.encodings.append(
        ...
        if is_r32(self.operands[0]) and is_r32(self.operands[1]):
            ...
            self.encodings.append(
                (
                    ...
                    + bytearray([0x01])
                    + modrm_sib_disp(5, op[1].address, sib, min_disp),
                )
            )
        elif is_r64(self.operands[0]) and is_r64(self.operands[1]):
            self.encodings.append(
        ...
        if is_r32(self.operands[0]) and is_r32(self.operands[1]):
            ...
            self.encodings.append(
                (
                    ...
                    + bytearray([0x01])
                    + modrm_sib_disp(3, op[1].address, sib, min_disp),
                )
            )
        elif is_r64(self.operands[0]) and is_r64(self.operands[1]):
            self.encodings.append(
        ...
        if is_r32(self.operands[0]) and is_r32(self.operands[1]):
            ...
            self.encodings.append(
                (
                    ...
                    + bytearray([0x01])
                    + modrm_sib_disp(2, op[1].address, sib, min_disp),
                )
            )
        elif is_r64(self.operands[0]) and is_r64(self.operands[1]):
            self.encodings.append(
        ...
        if is_r32(self.operands[0]) and is_r32(self.operands[1]):
            ...
            self.encodings.append(
                (
                    0x10,
                    lambda op, sib=False, min_disp=0: vex3(
                        0xC4, 0b10, 0x00, 0, op[1].address, op[0].hlcode
                    )
                    + bytearray([0xF3])
                    + modrm_sib_disp(3, op[1].address, sib, min_disp),
                )
            ...
            self.encodings.append(
                (
                    0x10,
                    lambda op, sib=False, min_disp=0: vex3(
                        0xC4, 0b10, 0x80, 0, op[1].address, op[0].hlcode
                    )
                    + bytearray([0xF3])
                    + modrm_sib_disp(3, op[1].address, sib, min_disp),
                )
        ...
        if is_r32(self.operands[0]) and is_r32(self.operands[1]):
            ...
            self.encodings.append(
                (
                    ...
                    + bytearray([0x01])
                    + modrm_sib_disp(7, op[1].address, sib, min_disp),
                )
            )
        elif is_r64(self.operands[0]) and is_r64(self.operands[1]):
            self.encodings.append(
        ...
        if is_r32(self.operands[0]) and is_r32(self.operands[1]):
            ...
            self.encodings.append(
                (
                    ...
                    + bytearray([0x01])
                    + modrm_sib_disp(4, op[1].address, sib, min_disp),
                )
            )
        elif is_r64(self.operands[0]) and is_r64(self.operands[1]):
            self.encodings.append(
...
class CRC32(Instruction):
    ...
    def __init__(self, *args, **kwargs):
        ...
        * CRC32(r64, r8/m8)      [SSE4.2]
        ...
        self.out_regs = (True, False)
        self.out_operands = (True, False)
        self.isa_extensions = frozenset([nervapy.x86_64.isa.sse4_2])
        if is_r32(self.operands[0]) and is_r8(self.operands[1]):
            ...
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: bytearray([0xF2])
                    + optional_rex(op[0].hcode, op[1], rex or is_r8rex(op[1]))
                    + bytearray(
                        [0x0F, 0x38, 0xF0, 0xC0 | op[0].lcode << 3 | op[1].lcode]
                    ),
                )
            )
        elif is_r32(self.operands[0]) and is_r16(self.operands[1]):
            ...
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: bytearray([0x66, 0xF2])
                    + optional_rex(op[0].hcode, op[1], rex)
                    + bytearray(
                        [0x0F, 0x38, 0xF1, 0xC0 | op[0].lcode << 3 | op[1].lcode]
                    ),
                )
            )
        elif is_r32(self.operands[0]) and is_r32(self.operands[1]):
            ...
            self.encodings.append(
                (
                    0x30,
                    lambda op, rex=False, sib=False, min_disp=0: bytearray([0xF2])
                    + optional_rex(op[0].hcode, op[1].address, rex)
                    + bytearray([0x0F, 0x38, 0xF0])
                    + modrm_sib_disp(op[0].lcode, op[1].address, sib, min_disp),
                )
            ...
            self.encodings.append(
                (
                    0x30,
                    lambda op, rex=False, sib=False, min_disp=0: bytearray([0x66, 0xF2])
                    + optional_rex(op[0].hcode, op[1].address, rex)
                    + bytearray([0x0F, 0x38, 0xF1])
                    + modrm_sib_disp(op[0].lcode, op[1].address, sib, min_disp),
                )
            ...
            self.encodings.append(
                (
                    0x10,
                    lambda op, sib=False, min_disp=0: bytearray([0xF2])
                    + rex(1, op[0].hcode, op[1].address)
                    + bytearray([0x0F, 0x38, 0xF0])
                    + modrm_sib_disp(op[0].lcode, op[1].address, sib, min_disp),
                )
...
class CMOVA(Instruction):
    ...
    def __init__(self, *args, **kwargs):
        ...
        * CMOVA(r64, r64/m64)    [CMOV]
        ...
        self.out_regs = (True, False)
        self.out_operands = (True, False)
        self.isa_extensions = frozenset([nervapy.x86_64.isa.cmov])
        if is_r16(self.operands[0]) and is_r16(self.operands[1]):
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[0].hcode, op[1], rex)
                    + bytearray([0x0F, 0x47, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
        elif is_r16(self.operands[0]) and is_m16(self.operands[1]):
            self.encodings.append(
        ...
        if is_r16(self.operands[0]) and is_r16(self.operands[1]):
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[0].hcode, op[1], rex)
                    + bytearray([0x0F, 0x46, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
        elif is_r16(self.operands[0]) and is_m16(self.operands[1]):
            self.encodings.append(
        ...
        if is_r16(self.operands[0]) and is_r16(self.operands[1]):
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[0].hcode, op[1], rex)
                    + bytearray([0x0F, 0x43, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
        elif is_r16(self.operands[0]) and is_m16(self.operands[1]):
            self.encodings.append(
        ...
        if is_r16(self.operands[0]) and is_r16(self.operands[1]):
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[0].hcode, op[1], rex)
                    + bytearray([0x0F, 0x42, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
        elif is_r16(self.operands[0]) and is_m16(self.operands[1]):
            self.encodings.append(
        ...
        if is_r16(self.operands[0]) and is_r16(self.operands[1]):
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[0].hcode, op[1], rex)
                    + bytearray([0x0F, 0x44, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
        elif is_r16(self.operands[0]) and is_m16(self.operands[1]):
            self.encodings.append(
        ...
        if is_r16(self.operands[0]) and is_r16(self.operands[1]):
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[0].hcode, op[1], rex)
                    + bytearray([0x0F, 0x45, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
        elif is_r16(self.operands[0]) and is_m16(self.operands[1]):
            self.encodings.append(
        ...
        if is_r16(self.operands[0]) and is_r16(self.operands[1]):
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[0].hcode, op[1], rex)
                    + bytearray([0x0F, 0x4F, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
        elif is_r16(self.operands[0]) and is_m16(self.operands[1]):
            self.encodings.append(
        ...
        if is_r16(self.operands[0]) and is_r16(self.operands[1]):
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[0].hcode, op[1], rex)
                    + bytearray([0x0F, 0x4E, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
        elif is_r16(self.operands[0]) and is_m16(self.operands[1]):
            self.encodings.append(
        ...
        if is_r16(self.operands[0]) and is_r16(self.operands[1]):
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[0].hcode, op[1], rex)
                    + bytearray([0x0F, 0x4D, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
        elif is_r16(self.operands[0]) and is_m16(self.operands[1]):
            self.encodings.append(
        ...
        if is_r16(self.operands[0]) and is_r16(self.operands[1]):
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[0].hcode, op[1], rex)
                    + bytearray([0x0F, 0x4C, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
        elif is_r16(self.operands[0]) and is_m16(self.operands[1]):
            self.encodings.append(
        ...
        if is_r16(self.operands[0]) and is_r16(self.operands[1]):
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[0].hcode, op[1], rex)
                    + bytearray([0x0F, 0x40, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
        elif is_r16(self.operands[0]) and is_m16(self.operands[1]):
            self.encodings.append(
        ...
        if is_r16(self.operands[0]) and is_r16(self.operands[1]):
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[0].hcode, op[1], rex)
                    + bytearray([0x0F, 0x41, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
        elif is_r16(self.operands[0]) and is_m16(self.operands[1]):
            self.encodings.append(
        ...
        if is_r16(self.operands[0]) and is_r16(self.operands[1]):
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[0].hcode, op[1], rex)
                    + bytearray([0x0F, 0x4A, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
        elif is_r16(self.operands[0]) and is_m16(self.operands[1]):
            self.encodings.append(
        ...
        if is_r16(self.operands[0]) and is_r16(self.operands[1]):
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[0].hcode, op[1], rex)
                    + bytearray([0x0F, 0x4B, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
        elif is_r16(self.operands[0]) and is_m16(self.operands[1]):
            self.encodings.append(
        ...
        if is_r16(self.operands[0]) and is_r16(self.operands[1]):
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[0].hcode, op[1], rex)
                    + bytearray([0x0F, 0x48, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
        elif is_r16(self.operands[0]) and is_m16(self.operands[1]):
            self.encodings.append(
        ...
        if is_r16(self.operands[0]) and is_r16(self.operands[1]):
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[0].hcode, op[1], rex)
                    + bytearray([0x0F, 0x49, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
        elif is_r16(self.operands[0]) and is_m16(self.operands[1]):
            self.encodings.append(
        ...
        if is_r8(self.operands[0]):
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0x0F, 0x97, 0xC0 | op[0].lcode]),
                )
            )
            self.in_regs = (False,)
            self.out_regs = (True,)
        ...
        if is_r8(self.operands[0]):
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0x0F, 0x96, 0xC0 | op[0].lcode]),
                )
            )
            self.in_regs = (False,)
            self.out_regs = (True,)
        ...
        if is_r8(self.operands[0]):
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0x0F, 0x93, 0xC0 | op[0].lcode]),
                )
            )
            self.in_regs = (False,)
            self.out_regs = (True,)
        ...
        if is_r8(self.operands[0]):
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0x0F, 0x92, 0xC0 | op[0].lcode]),
                )
            )
            self.in_regs = (False,)
            self.out_regs = (True,)
        ...
        if is_r8(self.operands[0]):
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0x0F, 0x94, 0xC0 | op[0].lcode]),
                )
            )
            self.in_regs = (False,)
            self.out_regs = (True,)
        ...
        if is_r8(self.operands[0]):
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0x0F, 0x95, 0xC0 | op[0].lcode]),
                )
            )
            self.in_regs = (False,)
            self.out_regs = (True,)
        ...
        if is_r8(self.operands[0]):
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0x0F, 0x9F, 0xC0 | op[0].lcode]),
                )
            )
            self.in_regs = (False,)
            self.out_regs = (True,)
        ...
        if is_r8(self.operands[0]):
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0x0F, 0x9E, 0xC0 | op[0].lcode]),
                )
            )
            self.in_regs = (False,)
            self.out_regs = (True,)
        ...
        if is_r8(self.operands[0]):
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0x0F, 0x9D, 0xC0 | op[0].lcode]),
                )
            )
            self.in_regs = (False,)
            self.out_regs = (True,)
        ...
        if is_r8(self.operands[0]):
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0x0F, 0x9C, 0xC0 | op[0].lcode]),
                )
            )
            self.in_regs = (False,)
            self.out_regs = (True,)
        ...
        if is_r8(self.operands[0]):
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0x0F, 0x90, 0xC0 | op[0].lcode]),
                )
            )
            self.in_regs = (False,)
            self.out_regs = (True,)
        ...
        if is_r8(self.operands[0]):
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0x0F, 0x91, 0xC0 | op[0].lcode]),
                )
            )
            self.in_regs = (False,)
            self.out_regs = (True,)
        ...
        if is_r8(self.operands[0]):
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0x0F, 0x9A, 0xC0 | op[0].lcode]),
                )
            )
            self.in_regs = (False,)
            self.out_regs = (True,)
        ...
        if is_r8(self.operands[0]):
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0x0F, 0x9B, 0xC0 | op[0].lcode]),
                )
            )
            self.in_regs = (False,)
            self.out_regs = (True,)
        ...
        if is_r8(self.operands[0]):
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0x0F, 0x98, 0xC0 | op[0].lcode]),
                )
            )
            self.in_regs = (False,)
            self.out_regs = (True,)
        ...
        if is_r8(self.operands[0]):
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex or is_r8rex(op[0]))
                    + bytearray([0x0F, 0x99, 0xC0 | op[0].lcode]),
                )
            )
            self.in_regs = (False,)
            self.out_regs = (True,)
        ...
        * JA(rel32)
        ...
        if is_rel32(self.operands[0]):
            if is_rel8(self.operands[0]):
                self.encodings.append(
                    (0x00, lambda op: bytearray([0x77, op[0].offset & 0xFF]))
                )
            self.encodings.append(
                (
                    0x00,
    ...
    def __init__(self, *args, **kwargs):
        ...
        * JNA(rel32)
        ...
        if is_rel32(self.operands[0]):
            if is_rel8(self.operands[0]):
                self.encodings.append(
                    (0x00, lambda op: bytearray([0x76, op[0].offset & 0xFF]))
                )
            self.encodings.append(
                (
                    0x00,
    ...
    def __init__(self, *args, **kwargs):
        ...
        * JAE(rel32)
        ...
        if is_rel32(self.operands[0]):
            if is_rel8(self.operands[0]):
                self.encodings.append(
                    (0x00, lambda op: bytearray([0x73, op[0].offset & 0xFF]))
                )
            self.encodings.append(
                (
                    0x00,
    ...
    def __init__(self, *args, **kwargs):
        ...
        * JNAE(rel32)
        ...
        if is_rel32(self.operands[0]):
            if is_rel8(self.operands[0]):
                self.encodings.append(
                    (0x00, lambda op: bytearray([0x72, op[0].offset & 0xFF]))
                )
            self.encodings.append(
                (
                    0x00,
    ...
    def __init__(self, *args, **kwargs):
        ...
        * JE(rel32)
        ...
        if is_rel32(self.operands[0]):
            if is_rel8(self.operands[0]):
                self.encodings.append(
                    (0x00, lambda op: bytearray([0x74, op[0].offset & 0xFF]))
                )
            self.encodings.append(
                (
                    0x00,
    ...
    def __init__(self, *args, **kwargs):
        ...
        * JNE(rel32)
        ...
        if is_rel32(self.operands[0]):
            if is_rel8(self.operands[0]):
                self.encodings.append(
                    (0x00, lambda op: bytearray([0x75, op[0].offset & 0xFF]))
                )
            self.encodings.append(
                (
                    0x00,
    ...
    def __init__(self, *args, **kwargs):
        ...
        * JG(rel32)
        ...
        if is_rel32(self.operands[0]):
            if is_rel8(self.operands[0]):
                self.encodings.append(
                    (0x00, lambda op: bytearray([0x7F, op[0].offset & 0xFF]))
                )
            self.encodings.append(
                (
                    0x00,
    ...
    def __init__(self, *args, **kwargs):
        ...
        * JNG(rel32)
        ...
        if is_rel32(self.operands[0]):
            if is_rel8(self.operands[0]):
                self.encodings.append(
                    (0x00, lambda op: bytearray([0x7E, op[0].offset & 0xFF]))
                )
            self.encodings.append(
                (
                    0x00,
    ...
    def __init__(self, *args, **kwargs):
        ...
        * JGE(rel32)
        ...
        if is_rel32(self.operands[0]):
            if is_rel8(self.operands[0]):
                self.encodings.append(
                    (0x00, lambda op: bytearray([0x7D, op[0].offset & 0xFF]))
                )
            self.encodings.append(
                (
                    0x00,
    ...
    def __init__(self, *args, **kwargs):
        ...
        * JNGE(rel32)
        ...
        if is_rel32(self.operands[0]):
            if is_rel8(self.operands[0]):
                self.encodings.append(
                    (0x00, lambda op: bytearray([0x7C, op[0].offset & 0xFF]))
                )
            self.encodings.append(
                (
                    0x00,
    ...
    def __init__(self, *args, **kwargs):
        ...
        * JO(rel32)
        ...
        if is_rel32(self.operands[0]):
            if is_rel8(self.operands[0]):
                self.encodings.append(
                    (0x00, lambda op: bytearray([0x70, op[0].offset & 0xFF]))
                )
            self.encodings.append(
                (
                    0x00,
    ...
    def __init__(self, *args, **kwargs):
        ...
        * JNO(rel32)
        ...
        if is_rel32(self.operands[0]):
            if is_rel8(self.operands[0]):
                self.encodings.append(
                    (0x00, lambda op: bytearray([0x71, op[0].offset & 0xFF]))
                )
            self.encodings.append(
                (
                    0x00,
    ...
    def __init__(self, *args, **kwargs):
        ...
        * JP(rel32)
        ...
        if is_rel32(self.operands[0]):
            if is_rel8(self.operands[0]):
                self.encodings.append(
                    (0x00, lambda op: bytearray([0x7A, op[0].offset & 0xFF]))
                )
            self.encodings.append(
                (
                    0x00,
    ...
    def __init__(self, *args, **kwargs):
        ...
        * JNP(rel32)
        ...
        if is_rel32(self.operands[0]):
            if is_rel8(self.operands[0]):
                self.encodings.append(
                    (0x00, lambda op: bytearray([0x7B, op[0].offset & 0xFF]))
                )
            self.encodings.append(
                (
                    0x00,
    ...
    def __init__(self, *args, **kwargs):
        ...
        * JS(rel32)
        ...
        if is_rel32(self.operands[0]):
            if is_rel8(self.operands[0]):
                self.encodings.append(
                    (0x00, lambda op: bytearray([0x78, op[0].offset & 0xFF]))
                )
            self.encodings.append(
                (
                    0x00,
    ...
    def __init__(self, *args, **kwargs):
        ...
        * JNS(rel32)
        ...
        if is_rel32(self.operands[0]):
            if is_rel8(self.operands[0]):
                self.encodings.append(
                    (0x00, lambda op: bytearray([0x79, op[0].offset & 0xFF]))
                )
            self.encodings.append(
                (
                    0x00,
    ...
    def __init__(self, *args, **kwargs):
        ...
        * JMP(rel32)
        ...
        if is_rel32(self.operands[0]):
            if is_rel8(self.operands[0]):
                self.encodings.append(
                    (0x00, lambda op: bytearray([0xEB, op[0].offset & 0xFF]))
                )
            self.encodings.append(
                (
                    0x00,
            ...
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex)
                    + bytearray([0xFF, 0xE0 | op[0].lcode]),
                )
            )
            self.in_regs = (True,)
        elif is_m64(self.operands[0]):
...
class JRCXZ(BranchInstruction):
    ...
    def __init__(self, *args, **kwargs):
        ...
        * JRCXZ(rel8)
        ...
        if is_rel8(self.operands[0]):
            self.encodings.append(
                (0x00, lambda op: bytearray([0xE3, op[0].offset & 0xFF]))
            )
        ...
        if len(self.operands) == 0:
            ...
            if is_imm(self.operands[0]):
                ...
                self.encodings.append(
                    (
                        0x00,
                        lambda op: bytearray([0xC2, op[0] & 0xFF, (op[0] >> 8) & 0xFF]),
                    )
                )
                self.in_regs = (False,)
                self.out_regs = (False,)
        ...
        if is_rel32(self.operands[0]):
            ...
            self.encodings.append(
                (
                    0x20,
                    lambda op, rex=False: optional_rex(0, op[0], rex)
                    + bytearray([0xFF, 0xD0 | op[0].lcode]),
                )
            )
            self.in_regs = (True,)
        elif is_m64(self.operands[0]):
...
class CPUID(Instruction):
    ...
    def __init__(self, *args, **kwargs):
        ...
        * CPUID()    [CPUID]
        ...
        self.isa_extensions = frozenset([nervapy.x86_64.isa.cpuid])
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
...
class RDTSC(Instruction):
    ...
    def __init__(self, *args, **kwargs):
        ...
        * RDTSC()    [RDTSC]
        ...
        self._implicit_out_regs = {0: 7, 2: 7}
        self.isa_extensions = frozenset([nervapy.x86_64.isa.rdtsc])
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
...
class RDTSCP(Instruction):
    ...
    def __init__(self, *args, **kwargs):
        ...
        * RDTSCP()    [RDTSCP]
        ...
        self.isa_extensions = frozenset([nervapy.x86_64.isa.rdtscp])
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
        ...
        if is_r8(self.operands[0]) and is_r8(self.operands[1]):
            ...
            self.encodings.append(
                (
                    ...
                    + bytearray([0x0F, 0xC0, 0xC0 | op[1].lcode << 3 | op[0].lcode]),
                )
            )
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[1].hcode, op[0], rex)
                    + bytearray([0x0F, 0xC1, 0xC0 | op[1].lcode << 3 | op[0].lcode]),
                )
            )
            self.out_regs = (True, True)
        elif is_r32(self.operands[0]) and is_r32(self.operands[1]):
        ...
        if is_r8(self.operands[0]) and is_r8(self.operands[1]):
            ...
            self.encodings.append(
                (
                    ...
                    + bytearray([0x86, 0xC0 | op[1].lcode << 3 | op[0].lcode]),
                )
            )
            self.encodings.append(
                (
                    ...
                    + bytearray([0x86, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
            self.out_regs = (True, True)
        elif is_r8(self.operands[0]) and is_m8(self.operands[1]):
            ...
            if is_ax(self.operands[0]):
                self.encodings.append(
                    (
                        0x21,
                        lambda op, rex=False: bytearray([0x66])
                        + optional_rex(0, op[1], rex)
                        + bytearray([0x90 | op[1].lcode]),
                    )
                )
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[1].hcode, op[0], rex)
                    + bytearray([0x87, 0xC0 | op[1].lcode << 3 | op[0].lcode]),
                )
            )
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[0].hcode, op[1], rex)
                    + bytearray([0x87, 0xC0 | op[0].lcode << 3 | op[1].lcode]),
                )
            )
            self.out_regs = (True, True)
        elif is_r16(self.operands[0]) and is_m16(self.operands[1]):
            ...
            if is_eax(self.operands[0]):
                self.encodings.append(
                    (
                        0x21,
                        lambda op, rex=False: optional_rex(0, op[1], rex)
                        + bytearray([0x90 | op[1].lcode]),
                    )
                )
            self.encodings.append(
            ...
            if is_rax(self.operands[1]):
                self.encodings.append(
                    (
                        0x02,
                        lambda op: bytearray([0x48 | op[0].hcode, 0x90 | op[0].lcode]),
                    )
                )
            if is_rax(self.operands[0]):
                self.encodings.append(
                    (
                        0x01,
                        lambda op: bytearray([0x48 | op[1].hcode, 0x90 | op[1].lcode]),
                    )
                )
            self.encodings.append(
                (
        ...
        if is_r8(self.operands[0]) and is_r8(self.operands[1]):
            ...
            self.encodings.append(
                (
                    ...
                    + bytearray([0x0F, 0xB0, 0xC0 | op[1].lcode << 3 | op[0].lcode]),
                )
            )
            self.out_regs = (True, False)
        elif is_r16(self.operands[0]) and is_r16(self.operands[1]):
            ...
            self.encodings.append(
                (
                    ...
                    lambda op, rex=False: bytearray([0x66])
                    + optional_rex(op[1].hcode, op[0], rex)
                    + bytearray([0x0F, 0xB1, 0xC0 | op[1].lcode << 3 | op[0].lcode]),
                )
            )
            self.out_regs = (True, False)
        elif is_r32(self.operands[0]) and is_r32(self.operands[1]):
    ...
    def __init__(self, *args, **kwargs):
        ...
        * CMPXCHG8B(m64)
        ...
        if is_m64(self.operands[0]):
            ...
            raise SyntaxError(
                "Invalid operand types: CMPXCHG8B "
                + ", ".join(map(format_operand_type, self.operands))
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * CMPXCHG16B(m128)
        ...
        if (
            ...
            origin = inspect.stack()
        super(CMPXCHG16B, self).__init__(
            "CMPXCHG16B", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) != 1:
        ...
        if is_m128(self.operands[0]):
            ...
            raise SyntaxError(
                "Invalid operand types: CMPXCHG16B "
                + ", ".join(map(format_operand_type, self.operands))
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
...
class SFENCE(Instruction):
    ...
    def __init__(self, *args, **kwargs):
        ...
        * SFENCE()    [MMX+]
        ...
        self.isa_extensions = frozenset([nervapy.x86_64.isa.mmx_plus])
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * PREFETCHNTA(m8)    [MMX+]
        ...
        if (
            ...
            origin = inspect.stack()
        super(PREFETCHNTA, self).__init__(
            "PREFETCHNTA", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) != 1:
        ...
        if is_m8(self.operands[0]):
            ...
            raise SyntaxError(
                "Invalid operand types: PREFETCHNTA "
                + ", ".join(map(format_operand_type, self.operands))
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * PREFETCHT0(m8)    [MMX+]
        ...
        if (
            ...
            origin = inspect.stack()
        super(PREFETCHT0, self).__init__(
            "PREFETCHT0", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) != 1:
        ...
        if is_m8(self.operands[0]):
            ...
            raise SyntaxError(
                "Invalid operand types: PREFETCHT0 "
                + ", ".join(map(format_operand_type, self.operands))
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * PREFETCHT1(m8)    [MMX+]
        ...
        if (
            ...
            origin = inspect.stack()
        super(PREFETCHT1, self).__init__(
            "PREFETCHT1", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) != 1:
        ...
        if is_m8(self.operands[0]):
            ...
            raise SyntaxError(
                "Invalid operand types: PREFETCHT1 "
                + ", ".join(map(format_operand_type, self.operands))
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * PREFETCHT2(m8)    [MMX+]
        ...
        if (
            ...
            origin = inspect.stack()
        super(PREFETCHT2, self).__init__(
            "PREFETCHT2", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) != 1:
        ...
        if is_m8(self.operands[0]):
            ...
            raise SyntaxError(
                "Invalid operand types: PREFETCHT2 "
                + ", ".join(map(format_operand_type, self.operands))
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * PREFETCH(m8)    [PREFETCH]
        ...
        if is_m8(self.operands[0]):
            ...
            self.out_regs = (False,)
            self.out_operands = (False,)
            self.isa_extensions = frozenset([nervapy.x86_64.isa.prefetch])
        else:
            raise SyntaxError(
                "Invalid operand types: PREFETCH "
                + ", ".join(map(format_operand_type, self.operands))
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * PREFETCHW(m8)    [PREFETCHW]
        ...
        if is_m8(self.operands[0]):
            ...
            self.out_regs = (False,)
            self.out_operands = (False,)
            self.isa_extensions = frozenset([nervapy.x86_64.isa.prefetchw])
        else:
            raise SyntaxError(
                "Invalid operand types: PREFETCHW "
                + ", ".join(map(format_operand_type, self.operands))
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * PREFETCHWT1(m8)    [PREFETCHWT1]
        ...
        if (
            ...
            origin = inspect.stack()
        super(PREFETCHWT1, self).__init__(
            "PREFETCHWT1", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) != 1:
        ...
        if is_m8(self.operands[0]):
            ...
            self.out_regs = (False,)
            self.out_operands = (False,)
            self.isa_extensions = frozenset([nervapy.x86_64.isa.prefetchwt1])
        else:
            raise SyntaxError(
                "Invalid operand types: PREFETCHWT1 "
                + ", ".join(map(format_operand_type, self.operands))
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * CLFLUSH(m8)    [CLFLUSH]
        ...
        if is_m8(self.operands[0]):
            ...
            self.out_regs = (False,)
            self.out_operands = (False,)
            self.isa_extensions = frozenset([nervapy.x86_64.isa.clflush])
        else:
            raise SyntaxError(
                "Invalid operand types: CLFLUSH "
                + ", ".join(map(format_operand_type, self.operands))
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * CLFLUSHOPT(m8)    [CLFLUSHOPT]
        ...
        if (
            ...
            origin = inspect.stack()
        super(CLFLUSHOPT, self).__init__(
            "CLFLUSHOPT", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) != 1:
        ...
        if is_m8(self.operands[0]):
            ...
            self.out_regs = (False,)
            self.out_operands = (False,)
            self.isa_extensions = frozenset([nervapy.x86_64.isa.clflushopt])
        else:
            raise SyntaxError(
                "Invalid operand types: CLFLUSHOPT "
                + ", ".join(map(format_operand_type, self.operands))
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * CLWB(m8)    [CLWB]
        ...
        if is_m8(self.operands[0]):
            ...
            self.out_regs = (False,)
            self.out_operands = (False,)
            self.isa_extensions = frozenset([nervapy.x86_64.isa.clwb])
        else:
            raise SyntaxError(
                "Invalid operand types: CLWB "
                + ", ".join(map(format_operand_type, self.operands))
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
...
class CLZERO(Instruction):
    ...
    def __init__(self, *args, **kwargs):
        ...
        * CLZERO()    [CLZERO]
        ...
        self._implicit_in_regs = {0: 15}
        self.isa_extensions = frozenset([nervapy.x86_64.isa.clzero])
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
