...
class VFMADD132SS(Instruction):
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMADD132SS(xmm{k}{z}, xmm, xmm/m32)      [AVX512F]
        ...
        super(VFMADD132SS, self).__init__(
            "VFMADD132SS", origin=origin, prototype=prototype
        )
        ...
        if len(self.operands) == 3:
            ...
            if (
                ...
                self.isa_extensions = frozenset([nervapy.x86_64.isa.fma3])
            elif (
                is_xmm(self.operands[0])
                and is_xmm(self.operands[1])
                ...
                is_xmmkz(self.operands[0])
                and is_evex_xmm(self.operands[1])
                and is_m32(self.operands[2])
            ):
                self.encodings.append(
                    (
                        0x90,
                        lambda op, sib=False, min_disp=0: evex(
                            0b10,
                            0x05,
                            0b00,
                            op[0].ehcode,
                        ...
                        + bytearray([0x99])
                        + modrm_sib_disp(
                            op[0].lcode, op[2].address, sib, min_disp, disp8xN=4
                        ),
                    )
                )
                ...
                is_xmmkz(self.operands[0])
                and is_evex_xmm(self.operands[1])
                and is_evex_xmm(self.operands[2])
            ):
                self.encodings.append(
                    (
                        0x00,
                ...
                raise SyntaxError(
                    "Invalid operand types: VFMADD132SS "
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFMADD132SS"'
            )
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMADD213SS(xmm{k}{z}, xmm, xmm/m32)      [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFMADD213SS, self).__init__(
            "VFMADD213SS", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFMADD213SS "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFMADD213SS"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMADD231SS(xmm{k}{z}, xmm, xmm/m32)      [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFMADD231SS, self).__init__(
            "VFMADD231SS", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFMADD231SS "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFMADD231SS"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
...
class VFMADDSS(Instruction):
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMADDSS(xmm, xmm, xmm/m32, xmm)    [FMA4]
        ...
        self.out_operands = (True, False, False, False)
        self.avx_mode = True
        self.isa_extensions = frozenset([nervapy.x86_64.isa.fma4])
        if (
            is_xmm(self.operands[0])
            and is_xmm(self.operands[1])
            and is_xmm(self.operands[2])
            and is_xmm(self.operands[3])
        ):
            self.encodings.append(
                (
                    0x00,
                    lambda op: bytearray(
                        [
                            0xC4,
                            0xE3 ^ (op[0].hcode << 7) ^ (op[3].hcode << 5),
                            0xF9 ^ (op[1].hlcode << 3),
                            0x6A,
                            0xC0 | op[0].lcode << 3 | op[3].lcode,
                            op[2].hlcode << 4,
                        ]
                    ),
                )
            ...
            and is_xmm(self.operands[1])
            and is_xmm(self.operands[2])
            and is_m32(self.operands[3])
        ):
            self.encodings.append(
                (
                    0x10,
                    lambda op, sib=False, min_disp=0: vex3(
                        0xC4, 0b11, 0x81, op[0].hcode, op[3].address, op[1].hlcode
                    )
                    + bytearray([0x6A])
                    + modrm_sib_disp(op[0].lcode, op[3].address, sib, min_disp)
                    + bytearray([op[2].hlcode << 4]),
                )
            )
        elif (
            is_xmm(self.operands[0])
            ...
            self.encodings.append(
                (
                    ...
                    + bytearray([0x6A])
                    + modrm_sib_disp(op[0].lcode, op[2].address, sib, min_disp)
                    + bytearray([op[3].hlcode << 4]),
                )
            )
        else:
            raise SyntaxError(
                "Invalid operand types: VFMADDSS "
                + ", ".join(map(format_operand_type, self.operands))
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMSUB132SS(xmm{k}{z}, xmm, xmm/m32)      [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFMSUB132SS, self).__init__(
            "VFMSUB132SS", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFMSUB132SS "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFMSUB132SS"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMSUB213SS(xmm{k}{z}, xmm, xmm/m32)      [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFMSUB213SS, self).__init__(
            "VFMSUB213SS", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFMSUB213SS "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFMSUB213SS"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMSUB231SS(xmm{k}{z}, xmm, xmm/m32)      [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFMSUB231SS, self).__init__(
            "VFMSUB231SS", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFMSUB231SS "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFMSUB231SS"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMSUBSS(xmm, xmm, xmm/m32, xmm)    [FMA4]
        ...
        if (
            ...
            raise SyntaxError(
                "Invalid operand types: VFMSUBSS "
                + ", ".join(map(format_operand_type, self.operands))
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFNMADD132SS(xmm{k}{z}, xmm, xmm/m32)      [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFNMADD132SS, self).__init__(
            "VFNMADD132SS", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFNMADD132SS "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFNMADD132SS"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFNMADD213SS(xmm{k}{z}, xmm, xmm/m32)      [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFNMADD213SS, self).__init__(
            "VFNMADD213SS", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFNMADD213SS "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFNMADD213SS"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFNMADD231SS(xmm{k}{z}, xmm, xmm/m32)      [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFNMADD231SS, self).__init__(
            "VFNMADD231SS", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFNMADD231SS "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFNMADD231SS"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFNMADDSS(xmm, xmm, xmm/m32, xmm)    [FMA4]
        ...
        if (
            ...
            raise SyntaxError(
                "Invalid operand types: VFNMADDSS "
                + ", ".join(map(format_operand_type, self.operands))
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFNMSUB132SS(xmm{k}{z}, xmm, xmm/m32)      [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFNMSUB132SS, self).__init__(
            "VFNMSUB132SS", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFNMSUB132SS "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFNMSUB132SS"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFNMSUB213SS(xmm{k}{z}, xmm, xmm/m32)      [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFNMSUB213SS, self).__init__(
            "VFNMSUB213SS", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFNMSUB213SS "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFNMSUB213SS"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFNMSUB231SS(xmm{k}{z}, xmm, xmm/m32)      [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFNMSUB231SS, self).__init__(
            "VFNMSUB231SS", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFNMSUB231SS "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFNMSUB231SS"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFNMSUBSS(xmm, xmm, xmm/m32, xmm)    [FMA4]
        ...
        if (
            ...
            raise SyntaxError(
                "Invalid operand types: VFNMSUBSS "
                + ", ".join(map(format_operand_type, self.operands))
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMADD132SD(xmm{k}{z}, xmm, xmm/m64)      [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFMADD132SD, self).__init__(
            "VFMADD132SD", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                self.encodings.append(
                    (
                        0x10,
                        lambda op, sib=False, min_disp=0: vex3(
                            0xC4, 0b10, 0x81, op[0].hcode, op[2].address, op[1].hlcode
                        )
                        + bytearray([0x99])
                        + modrm_sib_disp(op[0].lcode, op[2].address, sib, min_disp),
                    )
                ...
                self.encodings.append(
                    (
                        ...
                        + bytearray([0x99])
                        + modrm_sib_disp(
                            op[0].lcode, op[2].address, sib, min_disp, disp8xN=8
                        ),
                    )
                )
                self.isa_extensions = frozenset([nervapy.x86_64.isa.avx512f])
                ...
                raise SyntaxError(
                    "Invalid operand types: VFMADD132SD "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFMADD132SD"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMADD213SD(xmm{k}{z}, xmm, xmm/m64)      [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFMADD213SD, self).__init__(
            "VFMADD213SD", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFMADD213SD "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFMADD213SD"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMADD231SD(xmm{k}{z}, xmm, xmm/m64)      [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFMADD231SD, self).__init__(
            "VFMADD231SD", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFMADD231SD "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFMADD231SD"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMADDSD(xmm, xmm, xmm/m64, xmm)    [FMA4]
        ...
        if (
            ...
            raise SyntaxError(
                "Invalid operand types: VFMADDSD "
                + ", ".join(map(format_operand_type, self.operands))
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMSUB132SD(xmm{k}{z}, xmm, xmm/m64)      [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFMSUB132SD, self).__init__(
            "VFMSUB132SD", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFMSUB132SD "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFMSUB132SD"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMSUB213SD(xmm{k}{z}, xmm, xmm/m64)      [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFMSUB213SD, self).__init__(
            "VFMSUB213SD", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFMSUB213SD "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFMSUB213SD"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMSUB231SD(xmm{k}{z}, xmm, xmm/m64)      [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFMSUB231SD, self).__init__(
            "VFMSUB231SD", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFMSUB231SD "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFMSUB231SD"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMSUBSD(xmm, xmm, xmm/m64, xmm)    [FMA4]
        ...
        if (
            ...
            raise SyntaxError(
                "Invalid operand types: VFMSUBSD "
                + ", ".join(map(format_operand_type, self.operands))
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFNMADD132SD(xmm{k}{z}, xmm, xmm/m64)      [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFNMADD132SD, self).__init__(
            "VFNMADD132SD", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFNMADD132SD "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFNMADD132SD"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFNMADD213SD(xmm{k}{z}, xmm, xmm/m64)      [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFNMADD213SD, self).__init__(
            "VFNMADD213SD", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFNMADD213SD "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFNMADD213SD"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFNMADD231SD(xmm{k}{z}, xmm, xmm/m64)      [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFNMADD231SD, self).__init__(
            "VFNMADD231SD", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFNMADD231SD "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFNMADD231SD"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFNMADDSD(xmm, xmm, xmm/m64, xmm)    [FMA4]
        ...
        if (
            ...
            raise SyntaxError(
                "Invalid operand types: VFNMADDSD "
                + ", ".join(map(format_operand_type, self.operands))
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFNMSUB132SD(xmm{k}{z}, xmm, xmm/m64)      [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFNMSUB132SD, self).__init__(
            "VFNMSUB132SD", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFNMSUB132SD "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFNMSUB132SD"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFNMSUB213SD(xmm{k}{z}, xmm, xmm/m64)      [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFNMSUB213SD, self).__init__(
            "VFNMSUB213SD", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFNMSUB213SD "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFNMSUB213SD"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFNMSUB231SD(xmm{k}{z}, xmm, xmm/m64)      [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFNMSUB231SD, self).__init__(
            "VFNMSUB231SD", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFNMSUB231SD "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFNMSUB231SD"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFNMSUBSD(xmm, xmm, xmm/m64, xmm)    [FMA4]
        ...
        if (
            ...
            raise SyntaxError(
                "Invalid operand types: VFNMSUBSD "
                + ", ".join(map(format_operand_type, self.operands))
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMADD132PS(zmm{k}{z}, zmm, zmm, {er})       [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFMADD132PS, self).__init__(
            "VFMADD132PS", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                is_ymm(self.operands[0])
                and is_ymm(self.operands[1])
                and is_ymm(self.operands[2])
            ):
                self.encodings.append(
                    (
                        0x00,
                ...
                is_ymm(self.operands[0])
                and is_ymm(self.operands[1])
                and is_m256(self.operands[2])
            ):
                self.encodings.append(
                    (
                        0x10,
                        lambda op, sib=False, min_disp=0: vex3(
                            0xC4, 0b10, 0x05, op[0].hcode, op[2].address, op[1].hlcode
                        )
                        + bytearray([0x98])
                        + modrm_sib_disp(op[0].lcode, op[2].address, sib, min_disp),
                    )
                ...
                is_zmmkz(self.operands[0])
                and is_zmm(self.operands[1])
                and is_m512_m32bcst(self.operands[2])
            ):
                self.encodings.append(
                    (
                        0x90,
                        ...
                        + bytearray([0x98])
                        + modrm_sib_disp(
                            op[0].lcode, op[2].address, sib, min_disp, disp8xN=64
                        ),
                    )
                )
                self.isa_extensions = frozenset([nervapy.x86_64.isa.avx512f])
                ...
                is_xmmkz(self.operands[0])
                and is_evex_xmm(self.operands[1])
                and is_m128_m32bcst(self.operands[2])
            ):
                self.encodings.append(
                    (
                        0x90,
                        ...
                        + bytearray([0x98])
                        + modrm_sib_disp(
                            op[0].lcode, op[2].address, sib, min_disp, disp8xN=16
                        ),
                    )
                )
                self.isa_extensions = frozenset(
                    [nervapy.x86_64.isa.avx512vl, nervapy.x86_64.isa.avx512f]
                )
            elif (
                is_xmmkz(self.operands[0])
                and is_evex_xmm(self.operands[1])
                ...
                is_ymmkz(self.operands[0])
                and is_evex_ymm(self.operands[1])
                and is_m256_m32bcst(self.operands[2])
            ):
                self.encodings.append(
                    (
                        0x90,
                        ...
                        + bytearray([0x98])
                        + modrm_sib_disp(
                            op[0].lcode, op[2].address, sib, min_disp, disp8xN=32
                        ),
                    )
                )
                self.isa_extensions = frozenset(
                ...
                is_ymmkz(self.operands[0])
                and is_evex_ymm(self.operands[1])
                and is_evex_ymm(self.operands[2])
            ):
                self.encodings.append(
                    (
                        0x00,
                ...
                raise SyntaxError(
                    "Invalid operand types: VFMADD132PS "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFMADD132PS"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMADD213PS(zmm{k}{z}, zmm, zmm, {er})       [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFMADD213PS, self).__init__(
            "VFMADD213PS", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFMADD213PS "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFMADD213PS"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMADD231PS(zmm{k}{z}, zmm, zmm, {er})       [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFMADD231PS, self).__init__(
            "VFMADD231PS", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFMADD231PS "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFMADD231PS"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMADDPS(ymm, ymm, ymm/m256, ymm)    [FMA4]
        ...
        if (
            ...
            and is_ymm(self.operands[1])
            and is_ymm(self.operands[2])
            and is_m256(self.operands[3])
        ):
            self.encodings.append(
                (
                    0x10,
                    lambda op, sib=False, min_disp=0: vex3(
                        0xC4, 0b11, 0x85, op[0].hcode, op[3].address, op[1].hlcode
                    )
                    + bytearray([0x68])
                    + modrm_sib_disp(op[0].lcode, op[3].address, sib, min_disp)
                    + bytearray([op[2].hlcode << 4]),
            ...
            self.encodings.append(
                (
                    0x10,
                    lambda op, sib=False, min_disp=0: vex3(
                        0xC4, 0b11, 0x05, op[0].hcode, op[2].address, op[1].hlcode
                    )
                    + bytearray([0x68])
                    + modrm_sib_disp(op[0].lcode, op[2].address, sib, min_disp)
                    + bytearray([op[3].hlcode << 4]),
            ...
            raise SyntaxError(
                "Invalid operand types: VFMADDPS "
                + ", ".join(map(format_operand_type, self.operands))
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMSUB132PS(zmm{k}{z}, zmm, zmm, {er})       [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFMSUB132PS, self).__init__(
            "VFMSUB132PS", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFMSUB132PS "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFMSUB132PS"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMSUB213PS(zmm{k}{z}, zmm, zmm, {er})       [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFMSUB213PS, self).__init__(
            "VFMSUB213PS", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFMSUB213PS "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFMSUB213PS"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMSUB231PS(zmm{k}{z}, zmm, zmm, {er})       [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFMSUB231PS, self).__init__(
            "VFMSUB231PS", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFMSUB231PS "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFMSUB231PS"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMSUBPS(ymm, ymm, ymm/m256, ymm)    [FMA4]
        ...
        if (
            ...
            raise SyntaxError(
                "Invalid operand types: VFMSUBPS "
                + ", ".join(map(format_operand_type, self.operands))
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFNMADD132PS(zmm{k}{z}, zmm, zmm, {er})       [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFNMADD132PS, self).__init__(
            "VFNMADD132PS", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFNMADD132PS "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFNMADD132PS"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFNMADD213PS(zmm{k}{z}, zmm, zmm, {er})       [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFNMADD213PS, self).__init__(
            "VFNMADD213PS", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFNMADD213PS "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFNMADD213PS"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFNMADD231PS(zmm{k}{z}, zmm, zmm, {er})       [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFNMADD231PS, self).__init__(
            "VFNMADD231PS", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFNMADD231PS "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFNMADD231PS"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFNMADDPS(ymm, ymm, ymm/m256, ymm)    [FMA4]
        ...
        if (
            ...
            raise SyntaxError(
                "Invalid operand types: VFNMADDPS "
                + ", ".join(map(format_operand_type, self.operands))
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFNMSUB132PS(zmm{k}{z}, zmm, zmm, {er})       [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFNMSUB132PS, self).__init__(
            "VFNMSUB132PS", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFNMSUB132PS "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFNMSUB132PS"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFNMSUB213PS(zmm{k}{z}, zmm, zmm, {er})       [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFNMSUB213PS, self).__init__(
            "VFNMSUB213PS", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFNMSUB213PS "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFNMSUB213PS"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFNMSUB231PS(zmm{k}{z}, zmm, zmm, {er})       [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFNMSUB231PS, self).__init__(
            "VFNMSUB231PS", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFNMSUB231PS "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFNMSUB231PS"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFNMSUBPS(ymm, ymm, ymm/m256, ymm)    [FMA4]
        ...
        if (
            ...
            raise SyntaxError(
                "Invalid operand types: VFNMSUBPS "
                + ", ".join(map(format_operand_type, self.operands))
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMADD132PD(zmm{k}{z}, zmm, zmm, {er})       [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFMADD132PD, self).__init__(
            "VFMADD132PD", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                self.encodings.append(
                    (
                        0x10,
                        lambda op, sib=False, min_disp=0: vex3(
                            0xC4, 0b10, 0x85, op[0].hcode, op[2].address, op[1].hlcode
                        )
                        + bytearray([0x98])
                        + modrm_sib_disp(op[0].lcode, op[2].address, sib, min_disp),
                    )
                ...
                is_zmmkz(self.operands[0])
                and is_zmm(self.operands[1])
                and is_m512_m64bcst(self.operands[2])
            ):
                self.encodings.append(
                    (
                        0x90,
                ...
                is_xmmkz(self.operands[0])
                and is_evex_xmm(self.operands[1])
                and is_m128_m64bcst(self.operands[2])
            ):
                self.encodings.append(
                    (
                        0x90,
                ...
                is_ymmkz(self.operands[0])
                and is_evex_ymm(self.operands[1])
                and is_m256_m64bcst(self.operands[2])
            ):
                self.encodings.append(
                    (
                        0x90,
                ...
                raise SyntaxError(
                    "Invalid operand types: VFMADD132PD "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFMADD132PD"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMADD213PD(zmm{k}{z}, zmm, zmm, {er})       [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFMADD213PD, self).__init__(
            "VFMADD213PD", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFMADD213PD "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFMADD213PD"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMADD231PD(zmm{k}{z}, zmm, zmm, {er})       [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFMADD231PD, self).__init__(
            "VFMADD231PD", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFMADD231PD "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFMADD231PD"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMADDPD(ymm, ymm, ymm/m256, ymm)    [FMA4]
        ...
        if (
            ...
            raise SyntaxError(
                "Invalid operand types: VFMADDPD "
                + ", ".join(map(format_operand_type, self.operands))
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMSUB132PD(zmm{k}{z}, zmm, zmm, {er})       [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFMSUB132PD, self).__init__(
            "VFMSUB132PD", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFMSUB132PD "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFMSUB132PD"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMSUB213PD(zmm{k}{z}, zmm, zmm, {er})       [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFMSUB213PD, self).__init__(
            "VFMSUB213PD", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFMSUB213PD "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFMSUB213PD"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMSUB231PD(zmm{k}{z}, zmm, zmm, {er})       [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFMSUB231PD, self).__init__(
            "VFMSUB231PD", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFMSUB231PD "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFMSUB231PD"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMSUBPD(ymm, ymm, ymm/m256, ymm)    [FMA4]
        ...
        if (
            ...
            raise SyntaxError(
                "Invalid operand types: VFMSUBPD "
                + ", ".join(map(format_operand_type, self.operands))
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFNMADD132PD(zmm{k}{z}, zmm, zmm, {er})       [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFNMADD132PD, self).__init__(
            "VFNMADD132PD", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFNMADD132PD "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFNMADD132PD"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFNMADD213PD(zmm{k}{z}, zmm, zmm, {er})       [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFNMADD213PD, self).__init__(
            "VFNMADD213PD", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFNMADD213PD "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFNMADD213PD"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFNMADD231PD(zmm{k}{z}, zmm, zmm, {er})       [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFNMADD231PD, self).__init__(
            "VFNMADD231PD", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFNMADD231PD "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFNMADD231PD"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFNMADDPD(ymm, ymm, ymm/m256, ymm)    [FMA4]
        ...
        if (
            ...
            raise SyntaxError(
                "Invalid operand types: VFNMADDPD "
                + ", ".join(map(format_operand_type, self.operands))
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFNMSUB132PD(zmm{k}{z}, zmm, zmm, {er})       [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFNMSUB132PD, self).__init__(
            "VFNMSUB132PD", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFNMSUB132PD "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFNMSUB132PD"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFNMSUB213PD(zmm{k}{z}, zmm, zmm, {er})       [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFNMSUB213PD, self).__init__(
            "VFNMSUB213PD", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFNMSUB213PD "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFNMSUB213PD"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFNMSUB231PD(zmm{k}{z}, zmm, zmm, {er})       [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFNMSUB231PD, self).__init__(
            "VFNMSUB231PD", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFNMSUB231PD "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFNMSUB231PD"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFNMSUBPD(ymm, ymm, ymm/m256, ymm)    [FMA4]
        ...
        if (
            ...
            raise SyntaxError(
                "Invalid operand types: VFNMSUBPD "
                + ", ".join(map(format_operand_type, self.operands))
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMADDSUB132PS(zmm{k}{z}, zmm, zmm, {er})       [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFMADDSUB132PS, self).__init__(
            "VFMADDSUB132PS", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFMADDSUB132PS "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFMADDSUB132PS"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMADDSUB213PS(zmm{k}{z}, zmm, zmm, {er})       [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFMADDSUB213PS, self).__init__(
            "VFMADDSUB213PS", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFMADDSUB213PS "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFMADDSUB213PS"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMADDSUB231PS(zmm{k}{z}, zmm, zmm, {er})       [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFMADDSUB231PS, self).__init__(
            "VFMADDSUB231PS", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFMADDSUB231PS "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFMADDSUB231PS"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMADDSUBPS(ymm, ymm, ymm/m256, ymm)    [FMA4]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFMADDSUBPS, self).__init__(
            "VFMADDSUBPS", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) != 4:
        ...
        if (
            ...
            raise SyntaxError(
                "Invalid operand types: VFMADDSUBPS "
                + ", ".join(map(format_operand_type, self.operands))
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMSUBADD132PS(zmm{k}{z}, zmm, zmm, {er})       [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFMSUBADD132PS, self).__init__(
            "VFMSUBADD132PS", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFMSUBADD132PS "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFMSUBADD132PS"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMSUBADD213PS(zmm{k}{z}, zmm, zmm, {er})       [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFMSUBADD213PS, self).__init__(
            "VFMSUBADD213PS", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFMSUBADD213PS "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFMSUBADD213PS"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMSUBADD231PS(zmm{k}{z}, zmm, zmm, {er})       [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFMSUBADD231PS, self).__init__(
            "VFMSUBADD231PS", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFMSUBADD231PS "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFMSUBADD231PS"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMSUBADDPS(ymm, ymm, ymm/m256, ymm)    [FMA4]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFMSUBADDPS, self).__init__(
            "VFMSUBADDPS", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) != 4:
        ...
        if (
            ...
            raise SyntaxError(
                "Invalid operand types: VFMSUBADDPS "
                + ", ".join(map(format_operand_type, self.operands))
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMADDSUB132PD(zmm{k}{z}, zmm, zmm, {er})       [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFMADDSUB132PD, self).__init__(
            "VFMADDSUB132PD", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFMADDSUB132PD "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFMADDSUB132PD"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMADDSUB213PD(zmm{k}{z}, zmm, zmm, {er})       [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFMADDSUB213PD, self).__init__(
            "VFMADDSUB213PD", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFMADDSUB213PD "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFMADDSUB213PD"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMADDSUB231PD(zmm{k}{z}, zmm, zmm, {er})       [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFMADDSUB231PD, self).__init__(
            "VFMADDSUB231PD", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFMADDSUB231PD "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFMADDSUB231PD"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMADDSUBPD(ymm, ymm, ymm/m256, ymm)    [FMA4]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFMADDSUBPD, self).__init__(
            "VFMADDSUBPD", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) != 4:
        ...
        if (
            ...
            raise SyntaxError(
                "Invalid operand types: VFMADDSUBPD "
                + ", ".join(map(format_operand_type, self.operands))
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMSUBADD132PD(zmm{k}{z}, zmm, zmm, {er})       [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFMSUBADD132PD, self).__init__(
            "VFMSUBADD132PD", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFMSUBADD132PD "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFMSUBADD132PD"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMSUBADD213PD(zmm{k}{z}, zmm, zmm, {er})       [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFMSUBADD213PD, self).__init__(
            "VFMSUBADD213PD", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFMSUBADD213PD "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFMSUBADD213PD"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMSUBADD231PD(zmm{k}{z}, zmm, zmm, {er})       [AVX512F]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFMSUBADD231PD, self).__init__(
            "VFMSUBADD231PD", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) == 3:
            self.in_regs = (True, True, True)
            ...
            if (
                ...
                raise SyntaxError(
                    "Invalid operand types: VFMSUBADD231PD "
                    + ", ".join(map(format_operand_type, self.operands))
                )
        elif len(self.operands) == 4:
            if (
            ...
            raise SyntaxError(
                'Invalid number of operands for instruction "VFMSUBADD231PD"'
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
    ...
    def __init__(self, *args, **kwargs):
        ...
        * VFMSUBADDPD(ymm, ymm, ymm/m256, ymm)    [FMA4]
        ...
        if (
            ...
            origin = inspect.stack()
        super(VFMSUBADDPD, self).__init__(
            "VFMSUBADDPD", origin=origin, prototype=prototype
        )
        self.operands = tuple(map(check_operand, args))
        if len(self.operands) != 4:
        ...
        if (
            ...
            raise SyntaxError(
                "Invalid operand types: VFMSUBADDPD "
                + ", ".join(map(format_operand_type, self.operands))
            )
        if nervapy.stream.active_stream is not None:
            nervapy.stream.active_stream.add_instruction(self)
